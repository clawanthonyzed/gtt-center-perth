...
- AM model: **12 clients/day, 07:00 start, 6 slots/chair** (corrected 2026-07-30 — was 10 clients/day/5 slots-per-chair; Anthony committed the extended morning WDP's real 10:30am start-time guidance allows). Packages: only A$250/A$300 (Package 1 dropped). Saturday reuses AM + PM standalone, same 12-client volume. Sunday closed. **8-staff treatment roster required at this design ceiling (no pooling reduction — the 7/6-staff findings only ever applied at the now-superseded 10-client volume). 8-staff-unpooled is not "banned" — it's correct and expected at the 12-client ceiling; 7-staff-pooled (Massage+Beauty) remains valid for lower-volume actual rostering days, not retired as a concept.** **N_max search, 2026-07-30 later same day (explored, rejected):** per Anthony's "12 or max capacity" instruction, the full optimization search found a true chair-only ceiling of 14 clients/day, but it requires 12 treatment staff (not 8) and is financially worse than 12 (net -A$9,538.33/month) — **12 clients/day, 8-staff remains the committed model; N_max=14 is documented, not adopted.** See `docs/CURRENT-STATE.md` §1/§7 for the full search result.

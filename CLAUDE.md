...
- AM model: **12 clients/day, 07:00 start, 6 slots/chair** (corrected 2026-07-30 — was 10 clients/day/5 slots-per-chair; Anthony committed the extended morning WDP's real 10:30am start-time guidance allows). Packages: only A$250/A$300 (Package 1 dropped). Saturday reuses AM + PM standalone, same 12-client volume. Sunday closed. **Treatment staff are hired dual/multi-qualified, full stop — there is no "unpooled" model.** 8 dual-qualified staff required by peak overlap at the 12-client design ceiling (Massage+Beauty pool's own peak concurrency is 4 at this volume, no further reduction from pooling here — that's 4+2 Nails+2 Hair); 7 (Massage+Beauty pool sized to 3) remains valid for lower-volume actual rostering days, not retired as a concept. **N_max search, RE-CORRECTED 2026-07-31:** per Anthony's "12 or max capacity" instruction, the full optimization search found a true chair-only ceiling of 14 clients/day. Re-tested treatment headcount with Massage+Beauty dual-qualification against the real bursty 14-client timing (not a naive per-line multiply) — true minimum is **9 dual-qualified staff (3 Massage+Beauty pool + 3 Nails + 3 Hair), not 12.** Net financial verdict: **+A$6,155.17/month better than staying at 12** (extra revenue A$11,000/month vs extra labor only A$4,844.83/month) — reverses the earlier "12 remains committed" conclusion, which used an uncorrected headcount estimate. Adopting 14 as committed is presented as a finding, not decided here — Anthony's call. See `docs/CURRENT-STATE.md` §1/§4/§7 for the full search result and method.

...
**Source:** [king-edward-start-time-constraint.md](king-edward-start-time-constraint.md) (existing, still open)
...
**Source:** [HANDOFF.md](HANDOFF.md) (existing, still open)
...
**Source:** This session ([00_document_inventory.md](00_document_inventory.md))
...
**Source:** This session ([01_conflicts_log.md](01_conflicts_log.md) CONFLICT-03, secondary finding)
[scenario-c-timeline.html](scenario-c-timeline.html) (the visual companion to the staggered, pre-sync Scenario C) was identified as likely superseded by [scenario-c-sync-timeline.html](scenario-c-sync-timeline.html) but was not confirmed or flagged this session due to time constraints. **Action: verify and flag/update if confirmed stale.**
...
**Source:** Existing ([emergency-plan.md](emergency-plan.md))
...
**Source:** This session, cross-referenced against [review-audit.md](review-audit.md)
...
**Source:** This session ([01_conflicts_log.md](01_conflicts_log.md) CONFLICT-01, CONFLICT-02)

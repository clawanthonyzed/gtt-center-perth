...
| Hospitality | The welcome/itinerary card and leaving gesture already established in `docs/experience/CUSTOMER-JOURNEY.md` | A specific script/process for the AM/PM handover moment | — | — |

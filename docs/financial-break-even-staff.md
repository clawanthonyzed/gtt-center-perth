...
**Clarifying note, not a contradiction:** 8-staff-unpooled is not "banned" below the ceiling, nor is it the only option ever considered at the ceiling — it's the correct, expected, re-verified requirement AT the 12-client design ceiling. On lower-volume actual rostering days (below the ceiling), 7-staff-pooled (Massage+Beauty) remains a legitimate choice — a genuine daily-rostering saving that doesn't apply at peak, but does apply on quieter days. Design ceiling (8-unpooled, required at 12/day) and daily rostering (7-pooled, valid below it) are two different levels, not competing figures.

**N_max search, 2026-07-30, later same day (explored, rejected — headcount stays at 8):** per Anthony's "12 or max capacity" instruction, re-ran the full optimization search — the true chair/draw-timing ceiling is 14 clients/day, not 12, but achieving it would require **12 treatment staff (3 per line), not 8** — the bursty schedule the search produces peaks at 3 concurrent clients per treatment line during two arrival clusters. Extra revenue from 14 vs 12 (A$11,000/month) is less than the extra labor cost of the 4 additional staff needed (A$20,538.33/month) — net -A$9,538.33/month, worse than staying at 12. **The 8-person committed headcount above is unchanged and remains correct.** Full detail in `docs/CURRENT-STATE.md` §1/§7.
...
**2026-07-30 (N_max search explored and rejected; 8-staff-not-banned clarification; 7-staff-pooled reinstated for low-volume days)** — Per Anthony's "12 or max capacity" instruction, re-ran the full optimization search: true chair-only ceiling is 14, but requires 12 treatment staff (not 8, peak concurrency 3/line not 2) and is financially worse than 12 (net -A$9,538.33/month) — 8-person committed headcount unchanged. Added a clarifying note: 8-staff-unpooled is not "banned" below the 12-client ceiling and is correct/expected at it — the original instruction was about not defaulting to full/unpooled staffing on days that don't need it. 7-staff-pooled (Massage+Beauty) reinstated as a legitimate lower-volume daily-rostering choice, not retired as a concept.

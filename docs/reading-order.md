...
**Known gap:** [operations-manual.md](operations-manual.md)'s own scheduling section (Phase 5, below) still shows the old 8-client model — use [scenario-c-sync-timetables.md](scenario-c-sync-timetables.md) for the actual current timetable until that gap is closed.

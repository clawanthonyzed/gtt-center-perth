...
|---|---|---|
| Rent (commercial lease) | A$8,000 | 200 sqm @ A$40/sqm/month Subiaco area estimate |
| Wages — Imara (MD) | A$6,737 | Management salary |
| Wages — Phlebotomist | A$3,589 | HLT MA000027 L4 full-time |
| Wages — Massage therapist | A$3,529 | MA000005 L5 full-time |
| Wages — Nail tech | A$3,119 | MA000005 L3 full-time |
| Wages — Brows/beauty | A$2,127 | MA000005 L3 casual 3-day |
| Wages — Receptionist | A$3,474 | Clerks MA000002 L1 full-time |
| Superannuation (11.5% on wages) | A$2,588 | SG on A$22,575 gross wages |
| Workers comp (WA) | A$380 | ~1.7% wages (health industry) |
...
| Resend email platform | A$30 | Monthly — up to 50K emails |
...
Break-even = 108 visits/month ≈ 5 visits/day. Month 1 already exceeds break-even.
...
- Fixed costs = A$39,523/month (stable operations from Month 1)
...
| Month | GTT Visits | Wellness | Total Visits | GTT Rev | Wellness Rev | Subtenant | **Total Revenue** | Fixed Costs | **Net P&L** | Cumulative |
|---|---|---|---|---|---|---|---|---|---|---|
| **M1** | 88 | 88 | 176 | A$19,800 | A$15,400 | — | **A$35,200** | A$35,571 | **A$(371)** | A$(149,871) |
| **M2** | 132 | 110 | 242 | A$29,700 | A$19,250 | — | **A$48,950** | A$37,547 | **A$11,403** | A$(138,468) |
| **M3** | 154 | 132 | 286 | A$34,650 | A$23,100 | A$2,165 | **A$59,915** | A$39,523 | **A$20,392** | A$(118,076) |
| **M4** | 176 | 154 | 330 | A$39,600 | A$26,950 | A$2,165 | **A$68,715** | A$39,523 | **A$29,192** | A$(88,884) |
| **M5** | 176 | 154 | 330 | A$39,600 | A$26,950 | A$2,165 | **A$68,715** | A$39,523 | **A$29,192** | A$(59,692) |
| **M6** | 176 | 154 | 330 | A$39,600 | A$26,950 | A$2,165 | **A$68,715** | A$39,523 | **A$29,192** | A$(30,500) |
| **M7** | 176 | 154 | 330 | A$39,600 | A$26,950 | A$2,165 | **A$68,715** | A$39,523 | **A$29,192** | **A$(1,308)** |
| **M8** | 185 | 165 | 350 | A$41,625 | A$28,875 | A$2,165 | **A$72,665** | A$40,000 | **A$32,665** | **A$31,357** |
| **M9** | 185 | 165 | 350 | A$41,625 | A$28,875 | A$2,165 | **A$72,665** | A$40,000 | **A$32,665** | A$64,022 |
| **M10** | 185 | 165 | 350 | A$41,625 | A$28,875 | A$2,165 | **A$72,665** | A$40,000 | **A$32,665** | A$96,687 |
| **M11** | 185 | 165 | 350 | A$41,625 | A$28,875 | A$2,165 | **A$72,665** | A$40,000 | **A$32,665** | A$129,352 |
| **M12** | 185 | 165 | 350 | A$41,625 | A$28,875 | A$2,165 | **A$72,665** | A$40,000 | **A$32,665** | **A$162,017** |
| | | | | | | | | | | |
| **M13** | 198 | 176 | 374 | A$44,550 | A$30,800 | A$2,165 | **A$77,515** | A$42,000 | **A$35,515** | A$197,532 |
| **M14** | 198 | 176 | 374 | A$44,550 | A$30,800 | A$2,165 | **A$77,515** | A$42,000 | **A$35,515** | A$233,047 |
| **M15** | 198 | 176 | 374 | A$44,550 | A$30,800 | A$2,165 | **A$77,515** | A$42,000 | **A$35,515** | A$268,562 |
| **M16** | 198 | 176 | 374 | A$44,550 | A$30,800 | A$2,165 | **A$77,515** | A$42,000 | **A$35,515** | A$304,077 |
| **M17** | 198 | 176 | 374 | A$44,550 | A$30,800 | A$2,165 | **A$77,515** | A$42,000 | **A$35,515** | A$339,592 |
| **M18** | 198 | 176 | 374 | A$44,550 | A$30,800 | A$2,165 | **A$77,515** | A$42,000 | **A$35,515** | **A$375,107** |
...
|---|---|---|---|
| Low (A$209K) | A$209,000 | Month 1 | Month 8 |
| Mid (A$305K) | A$305,000 | Month 1 | Month 9–10 |
| High (A$431K) | A$431,000 | Month 1 | Month 12–13 |

**Operational break-even (covering monthly costs): Month 1** (176 visits > 108 required)  
**Capital recovery (full investment): Month 8–13 depending on startup capital**

### Annual P&L Summary
| Period | Revenue | Costs | Net Profit |
|---|---|---|---|
| Year 1 (M1–M12) | A$783,945 | A$469,710 | **A$314,235** |
| Year 2 (M13–M18 annualised ×2) | A$930,180 | A$504,000 | **A$426,180** |
...
| Break-even operations | Month 1 |
| Subtenant income live | Month 3 |
| Full capacity (15 visits/day) | Month 4 |
| Capital recovery (mid estimate) | Month 9–10 |
| Second phlebotomist hire | Month 6 (if waitlist overflow justifies) |
...
### Revenue Sensitivity (Stable Month — 330 visits at A$225 avg GTT, A$175 avg wellness)

| Scenario | Monthly Revenue | Monthly Costs | Monthly Profit | Annual Profit |
|---|---|---|---|---|
| Bear (70% capacity, no afternoon) | A$34,650 | A$39,523 | A$(4,873) | A$(58,476) |
| Base (100% as modelled) | A$68,715 | A$39,523 | A$29,192 | A$350,304 |
| Bull (120% — waitlist overflow, 2nd phlebotomist) | A$82,458 | A$45,000 | A$37,458 | A$449,496 |

### Cost Sensitivity — Rent Variation
| Rent Scenario | Monthly Rent | Monthly Profit (at base revenue) |
|---|---|---|
| Low (outer suburb: Osborne Park) | A$5,500 | A$31,692 |
| Base (Subiaco/Nedlands) | A$8,000 | A$29,192 |
| High (CBD adjacent) | A$12,000 | A$25,192 |

**Insight:** Even at high-rent location, profitable from Month 1. Location premium is worth it for proximity to antenatal demographic.

### Break-Even Visits (at different avg package prices)
| Avg Package | Break-Even Visits/Month | Break-Even Visits/Day |
|---|---|---|
| A$180 (conservative) | 135 | 6.1 |
| A$225 (base model) | 108 | 4.9 |
| A$260 (premium tier dominant) | 94 | 4.3 |

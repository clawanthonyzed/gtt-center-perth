...
| 6/325 Harborne Street, Osborne Park | 268sqm | A$55,000/yr net + GST | Retail/showroom type — slightly over target, negotiable, available immediately | AGORA Property Group — Shannon Swarts (0448 218 629) / Jonathan Kilborn (0404 796 137) | https://reiwa.com.au/6-325-harborne-street-osborne-park-4941752/ | **VERIFIED — only fully-verified candidate of the three (terminology corrected 2026-07-28: "lead" retired, see `property-links-2026-07-28.md`)** |
| 20 Parkland Road, Osborne Park | 994sqm, 28 parking | TBC | Part of a larger multi-floor A-grade building with varying space availability. **Size flag removed 2026-07-28 — 150sqm is a floor, no max specified, this is not automatically oversized.** | commercialrealestate.com.au #16969571 | https://www.commercialrealestate.com.au/property/20-parkland-road-osborne-park-wa-6017-16969571 | **UNVERIFIED CANDIDATE (fetch blocked) — confirm availability and true occupancy cost (rent+outgoings+GST vs A$96,000/yr budget) before ruling in or out** |

**Additional unverified candidates found in continued search 2026-07-28 (outside Osborne Park, per widened brief) — see `property-links-2026-07-28.md` for full detail: 45 Stirling Highway Nedlands (2 tenancies), 53 Hardy Road Nedlands (best layout match so far), Suite 6/1 Alvan Street Mount Lawley (parking constraint flagged), Suite 4/353 Cambridge Street Wembley (most parking found, needs rent figure).**

### Next Action (updated 2026-07-28)
- **AGORA Property Group** — 6/325 Harborne Street is the only VERIFIED candidate; contact Shannon Swarts (0448 218 629) or Jonathan Kilborn (0404 796 137)
- 2A/236 Main Street — remove from active shortlist, already leased
- 20 Parkland Road — pursue only if independently reconfirmed live (size is not a disqualifier per the 2026-07-28 correction)
- New unverified candidates (Nedlands x2, Mount Lawley, Wembley) — need agent calls to confirm price/size/availability before elevating to VERIFIED, see `property-links-2026-07-28.md`
- Filter: commercialrealestate.com.au → Osborne Park and beyond → min 150sqm, no max → ground floor preferred → parking confirmed BEFORE viewing — **and confirm current availability status before presenting any new candidate as verified, per the 2A/236 Main Street lesson above**

### Maylands / South Perth Hardy St Leads — Unconfirmed (re-checked 2026-07-27)
Per `VERIFICATION-TRACKER.md` Q9: Maylands (160sqm, 10 parking, negotiable rent) and South Perth Hardy St (216sqm, A$4,750/month) were referenced in `HANDOFF.md` as live leads from an earlier session, but no listing URL, agent name, or listing ID was ever saved anywhere in this repo. Re-searched directly 2026-07-27 (commercialrealestate.com.au, REIWA) — no property matching those exact specs currently exists in either suburb; the Hardy St listings that do exist (19 Hardy St, 22 Hardy St) are marked leased/inactive. **Treating both as unconfirmed rather than live leads. Quinn tasked with running a fresh, broader search of both suburbs (and/or Osborne Park/Joondalup as already-proven catchments) to find real replacement candidates — see team-meeting-2026-07-27.md follow-up tasking.**

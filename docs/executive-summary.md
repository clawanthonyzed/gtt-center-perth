...
Instead of a bare pathology waiting room while fasting, patients would spend the ~2-2.5 hour test window receiving massage, nails, brows, or hairdressing, bundled into one of two fixed-price packages with venue/lounge access included free (`services-pricing-locked.md`).
...
**Building an in-house NATA/RCPA-accredited collection centre (Option B) was investigated and rejected** — see `option-b-collection-centre.md` and `inhouse-gtt-research.md` — primarily due to the 12-18 month accreditation timeline.
...
Per `HANDOFF.md` (2026-07-17, the most recent session summary and source of truth for the active plan):
...
- **Packages:** 2 tiers only, renamed/renumbered 2026-07-20 — Package 1 (A$250, fixed 2×30min) and Package 2 (A$300, flexible composition), same 2 price points as before, not a re-opening of the earlier decision to drop the old A$200 tier (`services-pricing-locked.md`)
...
| Break-even (illustrative segment bookends — not the real mix) | ~355 Package 1 sales/month if 100% AM GTT packages (A$250 avg) OR ~933 services/month if 100% PM standalone services (A$95 avg) — the real plan blends both, see below | `profit-loss-tables.md`, `unit-economics.md` |
...
- **AI agent team** (Grace/operations, Reed/partnerships, Poppy/marketing, Ivy/booking, and others): planning, research, and documentation support — see `agents.md` for the full roster
...
**2026-07-20 (package renumbering + terminology)** — Updated package naming to Package 1 (A$250)/Package 2 (A$300) per `services-pricing-locked.md`'s renumbering. Switched from "visits" to "packages/services sold" as the core metric language in the break-even table and explanation, since a visit alone carries no dollar figure.

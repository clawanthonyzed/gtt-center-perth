...
## The GTT Procedure — What Staff Must Know

| Time | Event |
|------|-------|
| T minus 8–12 hrs | Patient fasts overnight (water OK) |
| T=0 (arrival) | Fasting blood draw (3 tubes) |
| T+5 | Patient drinks 75g glucose in 250mL water (finish in 5 min) |
| T+15 | Patient seated in lounge. **Services begin.** |
| T+60–90 | 1-hour blood draw (5 min, within flexible window) |
| T+120 | Final blood draw (5 min, fixed) |
| T+125 | Patient discharged |

**Total stay: 2–2.5 hours. Patient cannot leave between draws.**

**ADIPS 2025 thresholds:** Fasting ≥5.3 / 1-hr ≥10.6 / 2-hr ≥9.0 mmol/L → GDM positive.

**18% of GTT clients will test GDM positive** — the centre serves them before AND after diagnosis.

---

## Scheduling — How GTT Clients and Services Fit Together
...
|---------|----------|-------|-------|
| Pregnancy massage | 30 or 45 min | A$75 / A$120 | Massage therapist |
| Express facial | 30 or 45 min | A$95 / A$130 | Beauty therapist |
| Gel manicure | 45 min | A$75 | Nail tech |
...
Staff employed (casual/part-time). All service revenue flows to GTT Center Perth.
...
## DVA / Income Structure — Confirmed Safe

| Payment | Means Tested? | Affected by Trust? |
|---------|--------------|-------------------|
| TPI Disability Compensation | No | No |
| Commonwealth Super (Class A pension) | No | No |
| Service Pension | N/A — not held | N/A |
...
## Collection Room Requirements

- 12–14 sqm minimum
- Seamless vinyl flooring (no joins — infection control)
- Coved skirting (floor-to-wall junction sealed)
...
## Key Research Findings (Day 48)

| Topic | Finding |
|-------|---------|
| MIWM schedule | Single-client model, books 3–4 weeks ahead, 60-min or 2-hr spa included |
| Pathology fee | Not published — contact PathWest (08 6383 4234) before finalising pricing |
| Spray tan shower | Not mandated in WA — check local council for site-specific requirements |
| Belly cast pricing | A$250–330 is mid-to-below market (Natural Beginnings Perth charges A$770) |
| Classic lashes | A$140, 90 min — tight but possible in GTT window Service 2 slot |
| Full lash set | 2–2.5 hr — afternoon only |
| Hair colour | All types 1–4 hr — afternoon/standalone only |
| Fast-dry belly cast | Saves 5–15 min only vs traditional; recommend fast-dry for client comfort |

---

## GDM Management (Simplified)

18% of GTT clients get GDM positive. GTT Center Perth offers:
- Monthly/fortnightly external presenter (APD or diabetes educator, A$150–300/session)
- Free GDM resource packs (NDSS materials)
- CGM sensor retail (Freestyle Libre 2: A$105, 20–30% margin)
- GDM snack packs (A$20, 50%+ margin)

Does NOT offer: meal plans, NDSS registration, APD consultations (deferred indefinitely).

---

## Services Removed — Not Offered
...
|-------|--------|---------------|
| Month 1 (now) | Jun 2026 | Planning only. DVA advice. Location decision. |
| Month 2 | Jul 2026 | Hire receptionist/manager. Sign lease. Fit-out quotes. |
| Month 3 | Aug 2026 | Fit-out begins. Staff hiring. PathWest partnership confirmed. |
| Month 4 | Sep 2026 | Fit-out complete. Staff trained. Bookings open. |
| **Month 5** | **Oct 2026** | **LAUNCH. Fully booked from day 1 target.** |
| Month 6–12 | Nov 2026–Sep 2027 | Growth. Add 3rd staff per type at 80% capacity. |
| Month 13–18 | Oct 2027–Mar 2028 | Centre 2 planning and opening. |

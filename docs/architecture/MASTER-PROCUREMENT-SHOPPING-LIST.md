...
**Current Readiness totals (281 distinct items, 25 cross-reference rows excluded from scoring since they are not separate purchase decisions):** A. ORDER READY: 39. B. RFQ READY: 149. C. SITE DEPENDENT: 24. D. PROFESSIONAL VERIFICATION REQUIRED: 28. E. WDP DEPENDENT: 3. F. FOUNDER DECISION REQUIRED: 14. G. INFORMATION REQUIRED: 9. H. FUTURE / OPTIONAL: 15. **Updated 2026-08-26: the Massage table-vs-chair decision (F01b) closed, per direct founder decision (table/bed, not chairs), moving 1 item from F to H.**
...
**FOUNDER DECISION, CLOSED 2026-08-27: supersedes the "one room, 3-chair-ready" recommendation below.** Anthony has decided: **TWO Blood Collection Rooms, one per phlebotomist, specifically for extra client privacy.** This overrides the evidence-based recommendation in `docs/architecture/FIT-OUT-PROGRAM-DECISION-ANALYSIS.md` (Round 3, one room built for 3 chairs), which is now superseded by direct founder instruction, not reopened or second-guessed. This is a **room-configuration change, not a capacity change**: total phlebotomists (2) and total chairs (2, one per room) remain exactly as already costed and modelled, splitting the existing 2-chair capacity across 2 rooms rather than expanding it. The 18-clients/day AM model, headcount, and financial figures in `docs/CURRENT-STATE.md` are unaffected. See `docs/architecture/VENUE-PROGRAM-AUTHORITATIVE.md` and `docs/architecture/FIT-OUT-PROGRAM-DECISION-ANALYSIS.md` for the full updated record.

**Real consequences, flagged not silently absorbed:** every item below that is fixed room-level infrastructure (solid walls/door, door signage, ventilation, emergency call point) now needs 2 instances, not 1, updated directly in the rows below where the doubling is unambiguous. Several items are genuinely newly ambiguous now that there are 2 separate enclosed rooms rather than 1 shared room, and are flagged as open questions in their own rows rather than assigned an invented quantity: whether the centrifuge (E15) and specimen fridge (E16) are shared between the two rooms or duplicated, whether the vasovagal recliner (E04) needs one per room, whether the per-chair curtain (E32) is still needed once each chair already has its own solid door, and whether the growth path (previously a 3rd chair in the single room, E03) now means a 3rd room or a 2nd chair added to one of the two existing rooms. **Floor area:** the venue's required footprint increases materially, by roughly the same ~18-20sqm minimum floor area already estimated for a second Blood Collection Room in `docs/architecture/FIT-OUT-PROGRAM-DECISION-ANALYSIS.md` Part B's own evidence table, not a newly invented figure. **Cost:** no new fit-out cost figure is calculated here; the existing A$228,142-457,559 fit-out range and the day-one room count it was built against both need re-derivation once a venue exists, flagged as an open item, not recalculated in this pass.

**Current model (`docs/architecture/VENUE-PROGRAM-AUTHORITATIVE.md`):** two Blood Collection Rooms, one phlebotomist and one chair per room (Chair A in Room 1, Chair B in Room 2), compatible with a 4-phlebotomist employment pool (PHL01-PHL04, 2 simultaneous, 2 relief). Solid walls, no public-facing window, per room. Distinguishing: (1) GTT Center Perth purchases directly, (2) WDP-supplied items, (3) items dependent on WDP's final commercial arrangement, (4) items requiring Australian clinical/professional verification.
...
| E03 | Blood Collection | Furniture | 3rd phlebotomy chair (growth reservation) | Same spec as E01/E02 | 0 (day-one), 1 (growth) | each | CALCULATED | B. RFQ READY | No | No | PRO | Same as E01 | No | Yes | No | No | Open | **OPEN QUESTION, new 2026-08-27:** the prior "room built/serviced for 3 chairs from day one" basis no longer applies now that the venue has 2 separate 1-chair rooms rather than 1 shared room. Whether growth means a 3rd separate room or a 2nd chair added to one of the two existing rooms is not decided here, not invented |
| E04 | Blood Collection | Furniture | Vasovagal recliner/exam couch | Full recline to flat, for fainting/vasovagal recovery | 1 | each | LOCKED | A. ORDER READY | No | No | AU | Non-TGA furniture item | No | Yes | No | No | Priced | A$500-900. **OPEN QUESTION, new 2026-08-27:** with the 2 phlebotomy chairs now in separate rooms, whether 1 shared recliner (in a corridor/anteroom) is sufficient or each room needs its own, not decided here |
...
| ID | Category | Area | Item | Description / Specification | Quantity | Unit | Quantity Basis | Readiness | Opening Stock? | Reorderable? | Sourcing | Compliance / Verification | China Candidate? | Australian Source? | WDP Supplied? | Venue Dependent? | Status | Notes |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| E15 | Blood Collection | Specimen Handling | Tabletop centrifuge (refrigerated) | 3,000 RPM min, 8+ position rotor; GDM underdiagnosis risk without centrifugation within 10 minutes | 1 | each | LOCKED | E. WDP DEPENDENT | No | No | WDP | NATA acceptance confirmation before purchase of any non-established-brand alternative | No | Yes, if purchased directly (Hettich Universal 320R, Thermo Scientific CL10) | Likely, sourced via the WDP relationship, not general retail | No | Priced | A$1,800-5,000; the single most critical piece of equipment in the venue, do not compromise on quality. **OPEN QUESTION, new 2026-08-27:** with 2 separate Blood Collection Rooms rather than 1 shared room, whether one centrifuge can serve both rooms within the 10-minute window (e.g. a shared anteroom) or a second centrifuge is needed is a real cost question (a 2nd unit would add A$1,800-5,000), not decided here, not invented |
| E16 | Blood Collection | Specimen Handling | Specimen refrigerator | 2-8°C, temperature logged | 1 | each | LOCKED | B. RFQ READY | No | No | AU | Cold-chain, temperature-logging requirement | No | Yes | No | No | Open | **OPEN QUESTION, new 2026-08-27:** same shared-vs-per-room question as E15's centrifuge, not decided here |
...
| E24 | Blood Collection | Hand Hygiene | Clinical sink + elbow/sensor tap fitout | Elbow-operated or sensor tap, stainless/tiled splashback | 1 | each | SITE-DEPENDENT | C. SITE DEPENDENT | No | No | SITE | NSQHS Standards | No | Yes | No | Yes | Open | **Australian hydraulic verification required, local trade install.** **OPEN QUESTION, new 2026-08-27:** with 2 separate clinical rooms rather than 1, whether each room needs its own clinical hand-hygiene sink (likely, per standard infection-control practice for physically separate clinical spaces) is a genuine site-dependent/professional-verification question, not asserted as 2 here |
...
| ID | Category | Area | Item | Description / Specification | Quantity | Unit | Quantity Basis | Readiness | Opening Stock? | Reorderable? | Sourcing | Compliance / Verification | China Candidate? | Australian Source? | WDP Supplied? | Venue Dependent? | Status | Notes |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| E31 | Blood Collection | Construction | Solid walls, one door, no public-facing window | Room construction, not a shippable product | 2 | room | LOCKED | B. RFQ READY | No | No | SITE | Building surveyor, WA construction standard | No | Yes | No | Yes | Open | Quantity updated 2026-08-27: 2 rooms per founder decision (one per phlebotomist, for privacy), overriding the prior "1 room, 3-chair-ready" recommendation |
| E32 | Blood Collection | Privacy | Per-chair curtain/partition | Washable curtain fabric | 2-3 | each | CALCULATED | B. RFQ READY | No | No | HY | Infection control (washable fabric) | Possible | Either | No | Yes | Open | **OPEN QUESTION, new 2026-08-27:** this item's original rationale (partitioning between multiple chairs sharing 1 room) no longer straightforwardly applies now each chair has its own solid-walled, doored room. Whether a per-chair curtain is still needed inside each single-chair room, or the room's own door already provides the privacy this item was for, is not decided here |
| E33 | Blood Collection | Signage | Biohazard symbol (room door) | AS/NZS signage standard | 2 | each | LOCKED | B. RFQ READY | No | No | AU | AS/NZS signage standard | No | Yes | No | No | Open | Quantity updated 2026-08-27: one per room door, 2 rooms per founder decision |
...
| E35 | Blood Collection | Signage | "No entry when in use" signage | Door-mounted | 2 | each | LOCKED | B. RFQ READY | No | No | AU | None | No | Yes | No | No | Open | Quantity updated 2026-08-27: one per room door, 2 rooms per founder decision |
| E36 | Blood Collection | Emergency | Emergency call button/intercom to reception | Wired circuit | 2 | each | SITE-DEPENDENT | C. SITE DEPENDENT | No | No | AU | Electrical, WorkSafe | No | Yes | No | Yes | Open | Local trade install. Quantity updated 2026-08-27: one per room, 2 rooms per founder decision, since each room is now a physically separate space needing its own call point |
...
| E38 | Blood Collection | Ventilation | Room ventilation | 6 ACH per current spec | 1 | system | PROFESSIONAL-VERIFICATION | D. PROFESSIONAL VERIFICATION REQUIRED | No | No | SITE | Australian HVAC verification required | No | Yes | No | Yes | Open | Site-specific, local HVAC contractor. **OPEN QUESTION, new 2026-08-27:** 2 separate rooms will likely need 2 ventilation systems (or a shared system serving both, if the HVAC design allows), not asserted here, genuinely site-dependent |
...
| ID | Category | Area | Item | Description / Specification | Quantity | Unit | Quantity Basis | Readiness | Opening Stock? | Reorderable? | Sourcing | Compliance / Verification | China Candidate? | Australian Source? | WDP Supplied? | Venue Dependent? | Status | Notes |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| F01a | Massage | Furniture | Pregnancy massage table | Face hole + side cutouts, vinyl | 2 (day-one), up to 3 (growth) | each | CALCULATED | B. RFQ READY | No | No | HY | General consumer product safety | Possible, mandatory AU reference unit | Hybrid | No | No | Priced | A$800-2,500 AU / A$300-800 China-sourced. **DECIDED 2026-08-26: table/bed is the settled format, per direct founder decision (see PROCUREMENT-FOUNDER-DECISIONS.md). Not reopened.** |
| F01b | Massage | Furniture (not adopted) | Massage station chair | Format and spec not previously modelled anywhere in this repository | N/A, not adopted | each | OPTIONAL | H. FUTURE / OPTIONAL | No | No | Open | None established | Unknown | Unknown | No | No | Not proceeding | **CLOSED 2026-08-26: Anthony decided table/bed (F01a), not chairs. Retained as a record of the option considered; not a live procurement line, no quote should be sought for this item.** |

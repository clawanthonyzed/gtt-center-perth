# GTT Center Perth — Receptionist / Customer Experience Coordinator Recruitment
...
### Position: Receptionist / Customer Experience Coordinator
...
GTT Center Perth is a concept currently in the planning/feasibility stage for Western Australia's first dedicated Glucose Tolerance Test (GTT) wellness venue, pairing clinical-grade blood collection with premium pregnancy wellness services during the mandatory 2–3 hour GTT wait.
...
The Receptionist is the first and last point of contact for every client — opening the venue, greeting patients, coordinating the GTT booking flow with the phlebotomy team, managing the Fresha calendar, and handling end-of-visit checkout. This role reports to the Venue Manager.

---

### Key Responsibilities

- Open venue (7:15am): unlock, coffee/tea prep, lounge setup, check Fresha for the day's bookings
- Greet every patient by name on arrival; confirm fasting status, collect referral form and Medicare card
...
- Send post-visit SMS/email follow-up; collect Google review requests
...
## PART 2 — JOB ADVERTISEMENT (short form for posting — DO NOT POST YET)

**RECEPTIONIST / CUSTOMER EXPERIENCE COORDINATOR — New Maternal Wellness Concept | Perth WA**

A new maternal wellness venue concept, currently in planning, is seeking a Receptionist to be the first face our clients see each morning.
...
**Do not activate until venue location is confirmed, Recruitment Week 12.**

| Channel | Notes |
|---|---|
| SEEK | Standard listing |
| LinkedIn | Organic post |
| Local allied health / medical reception networks | Preferred experience pool |

---

## PART 4 — INTERVIEW PROCESS

Screening (phone, 15 min) and in-person interview conducted by the Venue Manager (already in place by Week 12 — see `staff-plan.md` §7 sequencing). Standard reference check (1 required) plus pre-employment checks (Police Clearance, WWVP).

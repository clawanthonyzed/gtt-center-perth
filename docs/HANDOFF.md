...
- **AM GTT:** 07:00 start (moved from 07:40), 2 chairs, 2 phlebotomists, **10 clients/day**. Formally verified timetable — "Scenario C" in [am-capacity-weekend.md](am-capacity-weekend.md) — zero double-bookings, checked against both phlebotomist scheduling and treatment-room concurrency (8 existing treatment staff, no new hires).

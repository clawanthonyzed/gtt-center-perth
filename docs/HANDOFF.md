...
- **AM GTT (historical, superseded twice, see docs/CURRENT-STATE.md):** 07:00 start (moved from 07:40), 2 chairs, 2 phlebotomists, **10 clients/day**. Formally verified timetable — "Scenario C" in [am-capacity-weekend.md](am-capacity-weekend.md) — zero double-bookings, checked against both phlebotomist scheduling and treatment-room concurrency (8 existing treatment staff, no new hires).
...
4. **Second venue** — 12-month proof-of-model precondition before committing capital, per [strategic-concerns-growth.md](strategic-concerns-growth.md). Victoria mentioned informally as a possible future interstate state — no timeline attached, just logged.
...
- [pm-staffing-roster.md](pm-staffing-roster.md) — PM model, waitlist/staffing decision framework, AM booking-driven rostering methodology, multi-role relief hiring
- [am-capacity-weekend.md](am-capacity-weekend.md) — AM capacity scenarios B/C/D (all verified timetables), Saturday/Sunday structure, the Saturday costing correction
- [profit-loss-tables.md](profit-loss-tables.md) — full P&L tables, v2.0 is current (conservative baseline, no Sunday)
- [strategic-concerns-growth.md](strategic-concerns-growth.md) — AM service availability, understaffing risk, profit ceiling, growth path, interstate expansion
- [pathology-partnership-brief.md](pathology-partnership-brief.md), [location-scouting.md](location-scouting.md), [onboarding.md](onboarding.md), [floor-plan-v3.svg](floor-plan-v3.svg)/`.pdf` — all current, no known stale figures as of this session

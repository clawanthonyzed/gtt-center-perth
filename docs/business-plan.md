...
1. Executive Summary
2. The Opportunity
3. The GTT Center Perth Concept
4. Customer & Market
5. Services & Customer Experience
6. Business Model
7. Venue & Operations
8. Pathology Partnership
9. Staffing & Operating Model
...
**Current stage and key dependency.** The venture is in the planning and feasibility stage. The venue design, staffing model, pricing structure, and financial model are complete. The single critical dependency before the venue can move into site selection and fit-out is confirmation of a pathology partnership: GTT Center Perth does not hold pathology accreditation itself and depends on a NATA-accredited pathology partner for blood collection oversight. This partnership is currently in active discussion and is addressed directly in Section 8.
...
Every pregnant woman in Western Australia undergoes this test as a matter of routine antenatal care; it is not a discretionary medical event that must be created or marketed into existence. The opportunity is not to generate demand for the underlying test, but to give an already-committed clinical appointment a materially better setting, and to build a broader wellness offering around that same premium environment and clientele.
...
Western Australia records an estimated 33,570 births each year, with Greater Perth accounting for approximately 26,790 of these (KPMG analysis of ABS Births, Australia 2024). Gestational diabetes screening is effectively universal in Australian antenatal care, meaning the GTT itself is undertaken by nearly every pregnant woman, translating to an estimated 515 GTT tests per week across the Perth metro area. Gestational diabetes is diagnosed in approximately 18% of those tested.
...
|---|---|---|---|
| MIWM (Mums in Waiting Melbourne) | Melbourne, VIC | Integrated GTT and spa, one client at a time | Established 2019, reported operating profitably and fully booked three to four weeks in advance |
| The GTT Lounge | Sydney, NSW | Integrated GTT and beauty | A smaller, less premium-positioned comparable, priced A$120-280 |
| Standard pathology collection centres | Perth | Clinical pathology only, no wellness component | No structured wait-time management identified |
| General pregnancy day spas | Perth (various) | Wellness only, no GTT integration | Comparable service pricing to GTT Center Perth's own offering |

GTT Center Perth's differentiation is a multi-client concurrent GTT and wellness model with a full hairdressing menu, purpose-built around the screening window itself. No direct GTT-integrated competitor has been identified in Western Australia.
...
|---|---|---|
| Package 1 | Venue and lounge access, plus two 30-minute services, fixed composition | A$250 |
| Package 2 | Venue and lounge access, plus client's choice of two 45-minute services, or one 45-minute and one 30-minute service, or two 30-minute services | A$300 |

All morning wellness services are 45 minutes or under, delivered by employed staff across massage, nails, brows, and hairdressing.

### Afternoon Wellness

The afternoon operates as a genuinely standalone wellness venue. Any client, whether or not she attended a GTT that morning, can book directly for individual services (massage, nails, hair, beauty) at an average modelled price of approximately A$95, or choose from a small menu of set packages combining two services at a fixed price. The afternoon service model draws on the same qualified staff pool as the morning shift.

### Operating Days

The venue operates Monday to Saturday. Saturday reuses the morning GTT model alongside standalone afternoon wellness. Sunday remains closed at launch, a position that will be reviewed once standalone afternoon demand is established and can support the added cost of Sunday staffing; this is a considered operating choice, not a regulatory requirement.

---

## 6. Business Model

GTT Center Perth generates revenue from three sources: morning GTT package sales, afternoon individual wellness services, and afternoon set packages, with a small ancillary contribution from cafe and retail sales during the client visit.

| Revenue Stream | Description | Volume Driver |
|---|---|---|
| Morning GTT packages | Package 1 (A$250) or Package 2 (A$300) per client, venue and lounge access included | Up to 18 packages sold per day at planning capacity |
| Afternoon individual services | Individual wellness services, averaging approximately A$95 per visit | Afternoon staff roster capacity |
...
**To be agreed.** WDP (Western Diagnostic Pathology) is the current prospective pathology partner, and discussions are active and ongoing. Partnership confirmation remains the critical pre-launch dependency for this venture. Commercial structure, phlebotomist employment arrangements, exact collection-room requirements, and certain clinical operating details will be finalised following confirmation of the partnership. No agreement has been signed, and no commercial terms have been agreed with WDP or any other pathology provider.
...
Staffing levels are calibrated to the current planning capacity of 18 clients per day and have been independently verified via two separate scheduling methods to confirm zero double-booking across the full daily timetable. Recruitment for the Venue Manager, the first hire, begins once a venue location is confirmed; all other recruitment follows.
...
**Soft launch.** Initial bookings are limited to the waitlist and a structured test-operations period before public opening.

**Full launch.** Public bookings open alongside paid social promotion, a live Google Business Profile, public relations outreach, and ongoing referral card distribution to partner practices.

**Growth.** Search-engine content, a referral reward programme, and regular in-person visits to top-referring practices support ongoing demand. A potential incentive to convert morning GTT clients into afternoon wellness clients is under consideration as a future retention mechanism, not yet modelled or committed.

**Genuine dependency, stated plainly:** referral relationships take time to build trust with practices that have no prior experience of the venue, and clinical referral volume in the first one to two months of operation should be expected to reflect that trust-building period rather than full market penetration.

---

## 11. Financial Overview

All figures in this section are planning estimates derived from the venture's current operating model. None are confirmed by actual trading data, since the venue has not yet opened.

### Startup Capital

The current adopted planning estimate for pre-opening capital is A$251,198, approved in principle as the current planning assumption following a cost-optimisation review; this figure is not a locked final cost and remains subject to a confirmed venue and real supplier quotes. Combined with a working capital reserve of A$85,000-110,000, the funding requirement is estimated in the range of A$336,198-361,198. A separate, more conservative reconciliation places the range at A$357,390-577,180. Both figures are shown transparently, since fit-out and trade costs remain estimates pending a confirmed venue.
...
The two largest unresolved inputs to this financial model are: the final phlebotomist employment and pathology commercial arrangement, which will be confirmed once the pathology partnership is finalised (Section 8), and actual referral-driven client volume, which cannot be known before the venue is trading. Both are treated transparently as open variables rather than embedded as settled assumptions.
...
Implementation is sequenced by dependency rather than by a fixed calendar, since a specific opening date has not been set.
...
7. **Pre-launch marketing:** waitlist and referral partnership activity intensifies during fit-out.
8. **Soft launch and opening:** a limited test-operations period precedes full public opening.

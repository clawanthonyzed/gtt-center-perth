...
> **CORRECTED 2026-08-15 — this document's own "current figure" pointers (§Key Metrics, §3) were themselves one recalculation stale.** They pointed to +A$63,028.75/month as current; the actual current canonical figure (post-superannuation, RECALCULATED 2026-08-09) is **+A$56,581.70/month (Table 1, PRIMARY)**. Fixed at the two pointer locations only — no other content rewritten. Always defer to `docs/CURRENT-STATE.md` §5 for the live figure rather than any number restated here.
...
| Monthly net P&L (historical, steady state, Month 5+ — superseded twice, see `docs/CURRENT-STATE.md` for the current +A$56,581.70/month primary figure, RECALCULATED 2026-08-09 for superannuation) | **+A$16,507.07/month** (ancillary revenue excluded 2026-07-30 — was +A$25,087.07/month) | `[MODELED — profit-loss-tables.md v2.1, 2026-07-30 recalculation — HISTORICAL, corrected 2026-08-15]` |
...
| **Net P&L (historical, Month 5+, steady state)** | **+A$16,507.07** (ancillary excluded 2026-07-30) | **+A$198,084.84** | `[MODELED — profit-loss-tables.md v2.1, precise weekday/Saturday-blended calculation, 2026-07-30 recalculation; not based on real trading data — since superseded twice, see docs/CURRENT-STATE.md for the current +A$56,581.70/month primary figure, RECALCULATED 2026-08-09 for superannuation — corrected 2026-08-15]` |

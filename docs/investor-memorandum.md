...
**GTT Center Perth transforms that wait into a premium day spa visit**: pregnancy massage, facial, gel nails, blowdry, lash lift, spray tan, and a full beauty service menu — all booked as a Package alongside the blood collection appointment. Blood collection is performed on-site by employed phlebotomists under a WDP/PathWest licensed collection centre arrangement.

**The only comparable service in Australia is MIWM in Melbourne** — single-client model, GP-led, Victoria only, 3–4 week wait times. GTT Center Perth runs 8 concurrent clients in the morning GTT window and offers individual service bookings in the afternoon for non-GTT clients.

### Key Metrics at a Glance

| Metric | Value |
|--------|-------|
| Blended average revenue per GTT package visit | **A$250** |
| AM GTT capacity (Month 5+) | **176 visits/month** (8/day × 22 days) |
| PM individual services capacity | **132+ sessions/month** (6+/day) |
| Monthly revenue at full capacity | **~A$77,000+** |
| Monthly fixed costs | A$74,391 |
| Capital requirement (mid-range estimate) | **~A$363,000** |
...
**GTT Center Perth's initial AM capacity is 176 GTT visits/month** — approximately 15% of Perth's total weekly GTT volume. Clients will travel from across Perth metro to access this service — location criteria prioritise ample parking and freeway access over proximity to any specific hospital.
...
Every GTT visit is sold as one of three Packages:

| Package | Inclusions | Price |
|---------|-----------|-------|
| **Package 1** | Venue + lounge access (free) + any 2 × 30-min services | **A$200** |
| **Package 2** | Venue + lounge access (free) + 1 × 30-min + 1 × 45-min service | **A$250** |
| **Package 3** | Venue + lounge access (free) + any 2 × 45-min services | **A$300** |

Package mix assumption: 30/40/30 → **blended average A$250 per GTT visit.**

Venue and lounge access are bundled free — there is no separate seat fee. Ancillary revenue (spray tan, retail, cafe) is additional to package revenue.

### PM Session — Individual Services

The afternoon session (12:00–18:00) is open to all clients (non-GTT) as individual service bookings at standard pricing. No minimum spend — clients book exactly the services they want.
...
PM sessions are served by the PM Service Therapist (12:00–18:00, 6 slots) plus any AM staff available for afternoon bookings. PM revenue is modelled separately to AM packages — average revenue per PM session is A$85–130 depending on service mix.
...
**No-interrupt rule:** Blood draws are timed to service transitions — no client is paused mid-massage or mid-treatment. Eight clients are managed concurrently using a staggered 20-minute arrival schedule, 2 phlebotomy chairs, 2 phlebotomists.

---

## 3. Financial Projections

### AM GTT Revenue — 18-Month Ramp

| Month | GTT Visits/Day | Monthly GTT Revenue | Notes |
|-------|---------------|--------------------|----|
| M1 (soft open) | 4 | A$22,000 | Ramp — referral network building |
| M2 | 6 | A$33,000 | |
| M3 | 7 | A$38,500 | |
| M4 | 8 | A$44,000 | Full AM capacity |
| M5+ | 8 | A$44,000 | Stable — plus ancillary A$8,167 |

*All AM revenue uses A$250 blended average (30/40/30 package mix).*

### Monthly P&L — Stable Operations (Month 4+, AM at full capacity)

| Line Item | Monthly | Annual |
|-----------|---------|--------|
| AM GTT Package revenue (176 visits × A$250) | A$44,000 | A$528,000 |
| PM Individual Service revenue (est. 132 sessions × A$95 avg) | A$12,540 | A$150,480 |
| Ancillary revenue (spray tan, retail, cafe) | A$8,167 | A$98,000 |
| **Total Revenue (Month 5+)** | **A$64,707** | **A$776,480** |
| Payroll — 14 staff + relief pool (incl. 12% super) | A$59,422 | A$713,067 |
| Workers compensation (WA, 1.7%) | A$989 | A$11,867 |
| Rent (200sqm, TBD — budget A$40/sqm) | A$8,000 | A$96,000 |
| Utilities, insurance, marketing, booking system, other | A$5,980 | A$71,760 |
| **Total Fixed Costs** | **A$74,391** | **A$892,694** |
| **Net P&L (Month 5+)** | **-A$9,684** | **-A$116,214** |

> **Revenue note:** At A$95 PM average and 132 PM sessions/month, the model does not break even on the current cost base. Break-even requires one of: (a) PM average spend increased to A$165+ per session (clients booking 2 services each), (b) additional PM volume beyond 132 sessions/month (involving AM staff for afternoon bookings), or (c) a higher AM GTT package blended average. Full PM revenue modelling is in progress — see `cash-flow.md` and `financial-break-even-staff.md` for sensitivity tables. The AM GTT side alone (A$44,000 + ancillary A$8,167 = A$52,167) does not clear the A$74,391 cost base; the PM session contribution is required for profitability.

### Unit Economics — AM GTT (confirmed)

| Metric | Value |
|--------|-------|
| Variable cost per visit | ~A$5 (consumables, linen, supplies) |
| Contribution margin per GTT visit (avg A$250) | **A$245 (98%)** |
| AM GTT break-even (AM + ancillary vs total costs) | Not standalone — PM contribution required |

---

## 4. Staffing Model

GTT Center Perth employs all service delivery staff directly. No subtenants. 14 employed roles + Casual Relief Pool.

| Role | FTE | Annual Cost (incl. 12% super) |
|------|-----|-------------------------------|
| Receptionist / Manager (AM 07:00–12:00 + PM 15:00–18:00 split shift) | 1.0 | A$56,237 |
| Phlebotomist × 2 (Chair A and Chair B, AM only) | 2.0 | A$86,136 |
| Pregnancy Massage Therapist × 2 | 2.0 | A$125,548 |
| Beauty Therapist × 2 (facial / brows / lashes) | 2.0 | A$125,548 |
| Nail Technician × 2 | 2.0 | A$120,912 |
| Hairdresser × 2 | 2.0 | A$120,912 |
| PM Service Therapist × 1 (cross-trained massage + facial, PM only) | 1.0 | A$62,774 |
| Casual Relief Pool (sick / holiday cover) | — | A$15,000 |
| **Total Annual Payroll** | | **A$713,067** |

**Operations Director:** Position to be recruited prior to launch. Responsible for day-to-day clinic operations, staff management, client experience, and reporting to the trust principals.
...
| Client model | Single client per session | 8 concurrent AM clients |
...
### Capital Stack (Mid-Range Estimate)

| Use | Amount |
|-----|--------|
| Fit-out / construction (partitions, plumbing, electrical, HVAC, flooring) | A$200,000 |
| Equipment and furnishings (see `equipment-costs.md` for full itemisation) | A$75,000 |
| IT, AV, signage, booking systems | A$13,000 |
| Working capital (pre-launch and ramp-up operating costs) | A$55,000 |
| Legal, professional fees, entity setup, ABN, insurance | A$20,000 |
| **Total Capital Requirement** | **A$363,000** |
| *Planning range (low construction / high construction)* | *A$292,000 – A$493,000* |
...
|-------|-------|----------------|
| Legal + entity setup | W1–2 | ABN, GST, business name, WDP contact initiated |
| Venue search | W2–4 | 5+ inspections in target suburbs, shortlist to 2 (see `location-scouting.md`) |
| Pathology agreement | W5–6 | WDP agreement negotiated and signed **before any lease signed** |
| Lease negotiation + execution | W6–8 | YETI Tipi Holdings PTY LTD as trustee signs |
| Architect brief + fit-out quotes | W7–9 | 3 builder quotes, council approval, WorkSafe WA nail LEV pre-application |
| Fit-out construction | W9–18 | 8–10 weeks (Perth mid-2026 commercial) |
| Staff recruitment | W12–18 | Phlebotomists, therapists, reception, Operations Director |
| Systems + marketing | W16–18 | Fresha live, Instagram, GP referral network activation |
| **Soft open** | **W20 (October 2026)** | AM GTT wave, reduced capacity |
| Full operation | M3 (December 2026) | AM + PM sessions ramping to capacity |
...
*Prepared by Idea Lobster (CEO Advisory System) on behalf of YETI Tipi Holdings PTY LTD ATF YETI Holding Trust | July 2026 | Version 2.0*

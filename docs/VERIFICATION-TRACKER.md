...
|---|---|---|---|---|
| 1 | WDP specimen dispatch cutoff time (11:30 vs 12:30 — two conflicting unconfirmed figures, neither from an actual WDP reply) | WDP (Carole Rivers, Customer & Commercial Manager, Country) | **OPEN — verbally answered 2026-07-29, written confirmation still needed** | Carole Rivers verbally confirmed there is no specimen-pickup cutoff within business operating hours `[VERIFIED — Carole Rivers, WDP, verbal confirmation, 2026-07-29]`. This is real and supersedes the 11:30/12:30 conflict for planning purposes, but is **not the same status as a written reply** — do not close this item out. **Action item:** get this specific confirmation in writing/email from WDP for the permanent record; not yet re-run into any scheduling document. See `cutoff-time-CORRECTION.md` 2026-07-29 update. |
| 2 | Whether overnight blood storage + next-day lab collection is viable as an alternative to the same-day courier cutoff | WDP | **OPEN, dependent on #1** | Could materially change the AM window end-time constraint if viable. Not to be assumed either way — WDP's determination alone. |

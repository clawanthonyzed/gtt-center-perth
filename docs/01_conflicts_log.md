...
**Purpose:** Every detected conflict, duplicate, or inconsistency across the docs corpus, with resolution status. Companion to [00_document_inventory.md](00_document_inventory.md) and [review-audit.md](review-audit.md) (which already logs many historical conflicts — this log adds newly found ones and cross-references the historical ones still open).
...
2. Synchronized Scenario C (both chairs start together) — in [scenario-c-sync-timetables.md](scenario-c-sync-timetables.md), dated 2026-07-17, one day newer, described as adding a treatment-staff concurrency check "previously only asserted, not built."
...
## Cross-Reference: Historical Conflicts Already Logged in [review-audit.md](review-audit.md)

[review-audit.md](review-audit.md) (the pre-existing full business audit) already documents a substantial set of conflicts, most now resolved. Listed here for completeness — do not re-litigate:
...
- **Package pricing:** [services-pricing-locked.md](services-pricing-locked.md), [HANDOFF.md](HANDOFF.md), and [financial-break-even-staff.md](financial-break-even-staff.md) all agree: 2 packages only, at A$250 and A$300 (renamed to Package 1/Package 2 respectively, 2026-07-20 — see [services-pricing-locked.md](services-pricing-locked.md) changelog). Consistent.
- **Saturday/Sunday model:** [HANDOFF.md](HANDOFF.md), [am-capacity-weekend.md](am-capacity-weekend.md) agree: Saturday reuses AM model + PM standalone (hours-based costing), Sunday closed. Consistent.
- **PM staffing model:** [pm-staffing-roster.md](pm-staffing-roster.md) is consistently cited as canonical by [business-plan.md](business-plan.md), [staff-plan.md](staff-plan.md), and [operations-manual.md](operations-manual.md) banners. Consistent (all three defer to it correctly).
- **Superannuation rate (12%):** Consistent across [staff-plan.md](staff-plan.md), [hr-framework.md](hr-framework.md), [financial-setup.md](financial-setup.md).
- **No subtenants:** Consistent across [staff-plan.md](staff-plan.md), [operations-manual.md](operations-manual.md) (Day 51 update explicitly removes subtenant-rent references). **Exception: [workflow.md](workflow.md) still describes a sublet model (massage/nails/hair/scan) — flagged below.**

**2026-07-20 (package renumbering)** — Updated the package-pricing consistency-check line above to reflect the renaming of the 2 surviving packages to Package 1 (A$250)/Package 2 (A$300) — see [services-pricing-locked.md](services-pricing-locked.md) changelog. Historical CONFLICT/IC entries elsewhere in this log describing the earlier Package 1/2/3 (A$200/250/300) naming are left as-is, since they are a historical record of past resolutions, not a statement of current fact.

---

## CONFLICT-04 | [workflow.md](workflow.md) — Stale Subtenant/Sublet Staffing Model

**Status: FLAGGED 2026-07-19 — not rewritten**

**Finding:** `docs/workflow.md`'s "Staffing Model (Launch)" table describes massage therapist, nail technician, hairdresser, and keepsake scan operator as **"Sublet"** roles, with phlebotomist as PathWest/WDP staff. This entirely contradicts the current, canonical model in [staff-plan.md](staff-plan.md), [financial-break-even-staff.md](financial-break-even-staff.md), and the Day 51 updates elsewhere: **all service delivery staff are employed** by GTT Center Perth (wage-based, not room rental), **there are no subtenants**, and the phlebotomists are **employed directly** by GTT Center Perth (not PathWest/WDP staff) — WDP/PathWest only provides the NATA accreditation umbrella and credentialing.

**Likely cause:** [workflow.md](workflow.md) appears to be an early draft (no version/date banner, no supersession markers anywhere in the file) that predates the Day 51 "no subtenants, employed model confirmed" decision and was never updated or flagged.

**Resolution:** Added a note in this session's changelog entry within [workflow.md](workflow.md) flagging the staffing table as stale, pointing to [staff-plan.md](staff-plan.md) as the current model. **The table itself was not rewritten** — recommended as a follow-up action (see roadmap) since it requires re-deriving the "keepsake scan operator" row too, which no longer exists in current scope (3D scan removed entirely per Day 51).

---

## CONFLICT-05 | [hire-purchase-china.md](hire-purchase-china.md) — 3D Scanner Section Timing
...
## CONFLICT-06 | [market-research-findings.md](market-research-findings.md) — 3D Scan Positioned as Core Differentiator
...
## CONFLICT-07 | [ivy-booking-system.md](ivy-booking-system.md) — Subtenant/Room-Rental Booking Model
...
| CONFLICT-08: multi-way PM-profitability and AM-capacity-figure discrepancies (Phase 6/7) | **Medium-High** (affects headline financial figures in business-plan.md/executive-summary.md) | **RESOLVED 2026-07-20** — see resolution detail below. Fixed in [pm-staffing-roster.md](pm-staffing-roster.md), [feasibility.md](feasibility.md), [capacity-pricing-audit.md](capacity-pricing-audit.md), [business-plan.md](business-plan.md), [executive-summary.md](executive-summary.md), [profit-loss-tables.md](profit-loss-tables.md), [cash-flow.md](cash-flow.md) |
| CONFLICT-09: payment-timing policy inconsistency (full prepayment vs A$30 deposit) | Medium (customer-facing billing/booking policy — must be resolved before any booking flow goes live) | **RESOLVED 2026-07-20** — Anthony confirmed full payment at booking. Fixed in [financial-setup.md](financial-setup.md), [operations-manual.md](operations-manual.md), [ivy-booking-system.md](ivy-booking-system.md), [website-spec.md](website-spec.md), `docs/pricing-billing-strategy.md` |

**Note on CONFLICT-03 (Scenario B vs C):** Anthony's Scenario D single-client 09:55 timing question was verified 2026-07-19 (see [am-capacity-weekend.md](am-capacity-weekend.md) "Can Client 15 Start at 09:55 Instead of 10:00?" and the updated recommendation in [king-edward-start-time-constraint.md](king-edward-start-time-constraint.md)) — this is a scheduling verification, not a documentation contradiction, so it isn't numbered as its own conflict here, but it's directly related to CONFLICT-03's root issue (the AM capacity model evolving faster than some documents track) and resolves the King Edward "before 10am" question for Scenario D specifically.

**CONFLICT-08 detail — RESOLVED 2026-07-20:** Three separate discrepancies surfaced while verifying [business-plan.md](business-plan.md), [executive-summary.md](executive-summary.md), [profit-loss-tables.md](profit-loss-tables.md), [cash-flow.md](cash-flow.md), and [break-even-sensitivity-analysis.md](break-even-sensitivity-analysis.md) against Phase 6/7 spec, all now resolved:

1. **PM-shift profitability — RESOLVED.** [pm-staffing-roster.md](pm-staffing-roster.md) (2026-07-14) reported the PM shift alone as a loss (-A$4,384/month) at Month 5+ steady state under the pre-Scenario-C (8-client) AM model. Verified this was an artifact of the stale 8-client AM revenue figure (A$44,000/month) rather than a genuine standalone loss — substituting the current 10-client Scenario C AM revenue (A$55,000/month) alone flips the reported figure to a positive contribution (~+A$6,616/month using [pm-staffing-roster.md](pm-staffing-roster.md)'s own PM/ancillary/cost figures). [profit-loss-tables.md](profit-loss-tables.md) v2.0 (2026-07-17, more recent, matches [HANDOFF.md](HANDOFF.md) exactly) is confirmed as the current authoritative figure: **+A$25,087.07/month at Month 5+ steady state.** Fixed in: [pm-staffing-roster.md](pm-staffing-roster.md) (banner + table flagged), [profit-loss-tables.md](profit-loss-tables.md) (PM/ancillary ramp figures filled in, Years 1-3 corrected), [cash-flow.md](cash-flow.md) (pointer updated), [business-plan.md](business-plan.md) (§4/§6/§9/§13 corrected), [executive-summary.md](executive-summary.md) (Financial Snapshot corrected).

2. **Market-sizing figures — RESOLVED.** WA births cited as ~18,000 in [research.md](research.md) v3.0 vs ~35,000 in [feasibility.md](feasibility.md) (with a screening rate of ~78% in one place vs "95%+, universal" in another). [research.md](research.md) v3.0 is the authoritative source — it is the explicitly-merged, most heavily cross-checked research document in this corpus, with a clear ABS/AIHW derivation chain that is internally consistent against national-level figures. [feasibility.md](feasibility.md)'s ~35,000/~28,000/95%+ figures could not be traced to a specific AIHW table this session and are corrected to match [research.md](research.md): ~18,000 WA births/year, ~14,400 Perth metro, ~277 GTT tests/week, ~100% universal screening, ~18% GDM diagnosis rate. Fixed in [feasibility.md](feasibility.md) (§1.1 corrected, §1.4 catchment figure flagged as needing its own recalculation since it wasn't a simple substitution) and [business-plan.md](business-plan.md) (§4 corrected to match). **Note:** [research.md](research.md) itself is explicitly out of scope for editing per the original task instruction (covers trust/ownership structure among other things, left untouched throughout this engagement) — its own capacity-vs-market comparison (§"GTT Center Perth Capacity vs Market," citing 30-40 bookings/week) also predates the current 10-client/50-per-week model, but this was not corrected since [research.md](research.md) is a protected file; flagged here for visibility only.

3. **A fifth AM-capacity-figure variant — RESOLVED.** [capacity-pricing-audit.md](capacity-pricing-audit.md) (2026-06-11) referenced a "12-client/2-chair model" as its own headline finding. Traced the root cause: this model depends on a relaxed Draw 3 rule ("no upper bound on the final draw") that was not carried forward into subsequent scheduling documents — every verified scheduling document since ([operations-manual.md](operations-manual.md), [scenario-c-sync-timetables.md](scenario-c-sync-timetables.md), [draw-event-scheduler-findings.md](draw-event-scheduler-findings.md), and this session's own `docs/scenario-e-floating-chair-investigation.md`) uses the bounded ±10min Draw 3 tolerance rule instead. The current standing capacity ceiling is confirmed as 10 clients/day (Scenario C, 2 chairs) or 15 clients/day (Scenario D, 3 chairs) — not 12. Fixed in [capacity-pricing-audit.md](capacity-pricing-audit.md) (§1 flagged as superseded throughout).

**Recommended follow-up (not urgent, process improvement only):** consider a single "current operational model" pointer document (already suggested in [03_improvements.md](03_improvements.md) P1) so future model changes don't require this kind of multi-document reconciliation sweep again.

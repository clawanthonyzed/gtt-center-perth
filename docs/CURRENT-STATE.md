...
>
> **FINANCIAL FINALISATION, 2026-08-18 (same day) — SUPERSEDES the figures above, the current, authoritative figures.** Two open items resolved by investigation, per Anthony's explicit "investigate, don't ask Anthony to pick" instruction. **(1) Insurance corrected:** neither A$400/month (an unexplained round guess) nor A$1,279/month (found this round to be methodologically flawed — double-counted workers compensation, already charged separately, and included an optional business-interruption line) was defensible. Corrected to A$708.34/month (Public Liability + Professional Indemnity + Property/Contents only, externally sanity-checked against real 2026 Australian small-business premium research) — non-wage overhead A$13,980.00 → A$14,288.34/month. **(2) Relief/absence coverage added:** the payroll model previously priced only the committed roster with zero absences, ever — a new, quantified recurring line (A$6,128.53/month, full-shift relief replacement at an 8% per-person absence-rate planning assumption) now represents this real cost. Full investigation and derivation: `docs/architecture/FINANCIAL-ASSUMPTION-REGISTER.md`. **CURRENT, authoritative steady-state Net Operating Result: A$32,576.80/month (Table 1) and -A$1,513.21/month (Table 2 — now genuinely loss-making at steady state).** Table 2's 24-month cumulative position now falls every month with no recovery (trough at Month 24, -A$172,138.34) — reported plainly, this remains sensitivity-only, never the planning case. Table 1 remains solidly net-positive throughout (annualised +A$390,921.60) and is unaffected in its status as the sole planning case. **The 18-client AM timetable itself remains independently solver-verified against the committed 8 treatment staff + 2 phlebotomists with zero collisions** (`docs/scenario-c-sync-timetables.md` §0.6a) — every correction this round has been a revenue/cost-realism finding, not an operational feasibility problem. Full detail: `docs/architecture/FINANCIAL-FIGURE-REFERENCE.md`, `docs/architecture/FINANCIAL-POSITION-CURRENT.md`, `docs/architecture/FINANCIAL-ASSUMPTION-REGISTER.md`.
...
| Relief/Absence Coverage Allowance | **A$6,128.53** (NEW this round — real, quantified expected cost of relief staff covering absences, previously entirely unmodelled; see `docs/architecture/FINANCIAL-ASSUMPTION-REGISTER.md`) | `[MODELLED — BALLPARK-ESTIMATE, based on an 8% per-person absence-rate planning assumption]` |
| **Total Costs** | **A$122,133.89** (was A$115,697.02) | `[CALCULATED]` |
| **Net P&L — PRIMARY COMMITTED STEADY-STATE FIGURE** | ~~+A$63,028.75/month~~ ~~+A$56,581.70/month~~ ~~+A$53,837.02/month~~ ~~+A$48,851.68/month~~ ~~+A$48,024.86/month~~ ~~+A$39,013.67/month~~ **+A$32,576.80/month (2026-08-18, Financial Finalisation round — a real cost-realism correction, insurance + relief/absence allowance now genuinely modelled; all older figures retained struck-through for trace, not deleted)** | `[CALCULATED — data/models/master_financial_model.yml#outputs.steady_state_summary, 2026-08-18]` |
| Quarterly | +A$97,730.40 (was +A$117,041.01) | `[CALCULATED — Monthly × 3]` |
| Half-Yearly | +A$195,460.80 (was +A$234,082.02) | `[CALCULATED — Monthly × 6]` |
| Yearly | +A$390,921.60 (was +A$468,164.04) | `[CALCULATED — Monthly × 12]` |
...
| Relief/Absence Coverage Allowance | A$6,128.53 (NEW) | `[MODELLED — BALLPARK-ESTIMATE]` |
| **Total Costs** | **A$116,728.90** (was A$110,292.03) | `[CALCULATED]` |
| **Net P&L — DOWNSIDE/SENSITIVITY REFERENCE FIGURE** | ~~+A$27,084.69/month~~ ~~+A$21,056.64/month~~ ~~+A$18,462.37/month~~ ~~+A$14,761.66/month~~ ~~+A$13,934.85/month~~ ~~+A$4,923.66/month~~ **-A$1,513.21/month (2026-08-18, Financial Finalisation round — Table 2 is now genuinely LOSS-MAKING at steady state, reported plainly, not smoothed over)** | `[CALCULATED, data/models/master_financial_model.yml, 2026-08-18]` |
| Quarterly | -A$4,539.63 (was +A$14,770.98) | `[CALCULATED]` |
| Half-Yearly | -A$9,079.26 (was +A$29,541.96) | `[CALCULATED]` |
| Yearly | -A$18,158.52 (was +A$59,083.92) | `[CALCULATED]` |

...
| Total Revenue (Monthly) — canonical methodology | **A$154,710.69** (unchanged this round — revenue side unaffected by the insurance/relief-cost correction; PM capacity/transaction reconciliation, 2026-08-18, see banner above and `docs/architecture/PM-CAPACITY-RECONCILIATION.md`) | `[CALCULATED — data/canonical/revenue_ramp.yml, deterministic output of tools/revenue_ramp_model.py]` |
| Total Direct Labor + Opening Costs | **A$84,658.03** (2026-08-21, Founder Decision round — Position 06/RCO01's receptionist_relief cost removed, was A$89,460.88; see `data/canonical/cost_ramp.yml#cost_table1_m5plus`) | `[CALCULATED — data/canonical/cost_ramp.yml, deterministic output of tools/cost_ramp_model.py]` |
| Workers Comp (1.7%) | **A$1,439.19** (2026-08-21 — recomputed on the reduced Direct Labor subtotal, was A$1,520.83) | `[MODELED — 1.7% convention, applied to the recomputed Direct Labor total; rate itself remains PLACEHOLDER, not VERIFIED]` |
| Non-Wage Overhead | **A$14,288.34** (2026-08-18 Financial Finalisation round — insurance corrected A$400→A$708.34/month, see `docs/architecture/FINANCIAL-ASSUMPTION-REGISTER.md` — was A$13,980.00) | `[MODELLED — BALLPARK-ESTIMATE, not a real quote, broker quotes in motion]` |
| Relief/Absence Coverage Allowance | **A$0.00** (REVERTED 2026-08-21, per direct founder instruction — was A$6,128.53 under the 2026-08-18 round; normal payroll/rostering treated as already absorbing absence coverage; see `data/canonical/cost_ramp.yml#conflict_relief_absence_allowance_reverted`) | `[DECIDED — founder instruction, 2026-08-21]` |
| **Total Costs** | **A$110,544.52** (2026-08-21, later same day — Position 06/RCO01 removed; was A$116,005.36 earlier the same day; A$122,133.89 under the 2026-08-18 round; A$115,697.02 before that) | `[CALCULATED]` |
| **Net P&L — PRIMARY COMMITTED STEADY-STATE FIGURE** | ~~+A$63,028.75/month~~ ~~+A$56,581.70/month~~ ~~+A$53,837.02/month~~ ~~+A$48,851.68/month~~ ~~+A$48,024.86/month~~ ~~+A$39,013.67/month~~ ~~+A$32,576.80/month~~ ~~+A$38,705.33/month~~ **+A$44,166.17/month (2026-08-21, Founder Decision round — Position 06/RCO01 dedicated PM Reception removed, service-staff coverage during PM booking gaps confirmed; all older figures retained struck-through for trace, not deleted)** | `[CALCULATED — data/models/master_financial_model.yml#outputs.steady_state_summary, 2026-08-21]` |
| Quarterly | +A$132,498.51 (was +A$116,115.99) | `[CALCULATED — Monthly × 3]` |
| Half-Yearly | +A$264,997.02 (was +A$232,231.98) | `[CALCULATED — Monthly × 6]` |
| Yearly | +A$529,994.04 (was +A$464,463.96) | `[CALCULATED — Monthly × 12]` |

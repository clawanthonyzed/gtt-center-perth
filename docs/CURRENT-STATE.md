...
>
> **FINANCIAL MODEL REBUILD, 2026-08-21 — SUPERSEDES the Financial Finalisation figures above, the current, authoritative figures.** Per direct founder instruction: the relief_absence_allowance line added 2026-08-18 is REVERTED to A$0.00/month — normal payroll/rostering (casual relief hiring, a colleague picking up an extra shift) is treated as already absorbing absence coverage, not a separate expected-value planning line stacked on top of it, unless a genuine, itemised, real cost basis for a separate line is identified (none has been). The insurance correction from the same 2026-08-18 round is UNCHANGED (still A$708.34/month). **CURRENT, authoritative steady-state Net Operating Result: A$38,705.33/month (Table 1) and A$4,615.32/month (Table 2 — returns to profitability at steady state).** Table 2's 24-month cumulative cash position trough returns to Month 4 (was Month 24 under the relief-allowance version) at -A$117,360.02, recovering afterward rather than deteriorating every month — though the 24-month cumulative total remains negative (-A$25,053.62), the annualised steady-state result is now positive. Table 1 remains solidly net-positive throughout (annualised +A$464,463.96) and is unaffected in its status as the sole planning case, beyond the figures themselves moving. **The 18-client AM timetable itself remains independently solver-verified against the committed 8 treatment staff + 2 phlebotomists with zero collisions** (`docs/scenario-c-sync-timetables.md` §0.6a) — this round's correction is a cost-line reversal, not an operational feasibility problem. Full detail: `data/canonical/cost_ramp.yml#conflict_relief_absence_allowance_reverted`, `data/models/master_financial_model.yml` (2026-08-21 banner).
...
| Total Direct Labor + Opening Costs | **A$89,460.88** (unchanged this round — PM labour hours are not affected; 2026-08-18 audit round — Venue Manager wage corrected to MA000005 L6; see `data/canonical/cost_ramp.yml#cost_table1_m5plus`) | `[CALCULATED — data/canonical/cost_ramp.yml, deterministic output of tools/cost_ramp_model.py]` |
| Workers Comp (1.7%) | **A$1,520.83** (unchanged this round) | `[MODELED — 1.7% convention, applied to the recomputed Direct Labor total; rate itself remains PLACEHOLDER, not VERIFIED]` |
...
| **Total Costs** | **A$116,005.36** (was A$122,133.89 under the 2026-08-18 round; A$115,697.02 before that) | `[CALCULATED]` |
| **Net P&L — PRIMARY COMMITTED STEADY-STATE FIGURE** | ~~+A$63,028.75/month~~ ~~+A$56,581.70/month~~ ~~+A$53,837.02/month~~ ~~+A$48,851.68/month~~ ~~+A$48,024.86/month~~ ~~+A$39,013.67/month~~ ~~+A$32,576.80/month~~ **+A$38,705.33/month (2026-08-21, Financial Model Rebuild round — relief_absence_allowance REVERTED to A$0.00 per direct founder instruction; all older figures retained struck-through for trace, not deleted)** | `[CALCULATED — data/models/master_financial_model.yml#outputs.steady_state_summary, 2026-08-21]` |
| Quarterly | +A$116,115.99 (was +A$97,730.40) | `[CALCULATED — Monthly × 3]` |
| Half-Yearly | +A$232,231.98 (was +A$195,460.80) | `[CALCULATED — Monthly × 6]` |
| Yearly | +A$464,463.96 (was +A$390,921.60) | `[CALCULATED — Monthly × 12]` |
...
| Total Direct Labor + Opening Costs | A$84,707.15 (unchanged this round) | `[CALCULATED — data/canonical/cost_ramp.yml#cost_table2_m5plus]` |
| Workers Comp (1.7%) | A$1,440.02 (unchanged this round) | `[MODELED — rate itself remains PLACEHOLDER, not VERIFIED]` |
...
| **Total Costs** | **A$110,600.37** (was A$116,728.90 under the 2026-08-18 round; A$110,292.03 before that) | `[CALCULATED]` |
| **Net P&L — DOWNSIDE/SENSITIVITY REFERENCE FIGURE** | ~~+A$27,084.69/month~~ ~~+A$21,056.64/month~~ ~~+A$18,462.37/month~~ ~~+A$14,761.66/month~~ ~~+A$13,934.85/month~~ ~~+A$4,923.66/month~~ ~~-A$1,513.21/month~~ **+A$4,615.32/month (2026-08-21, Financial Model Rebuild round — relief_absence_allowance REVERTED to A$0.00; Table 2 returns to profitability at steady state, no longer loss-making)** | `[CALCULATED, data/models/master_financial_model.yml, 2026-08-21]` |
| Quarterly | +A$13,845.96 (was -A$4,539.63) | `[CALCULATED]` |
| Half-Yearly | +A$27,691.92 (was -A$9,079.26) | `[CALCULATED]` |
| Yearly | +A$55,383.84 (was -A$18,158.52) | `[CALCULATED]` |

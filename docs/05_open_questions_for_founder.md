...
**Purpose:** Single running list of every question in the docs corpus that only Anthony can answer. Consolidates items previously scattered across `reading-order.md` "Open Decisions," `HANDOFF.md` "Still Open," `cutoff-time-CORRECTION.md`, `king-edward-start-time-constraint.md`, and inline notes in `review-audit.md`. **This is now the single source of truth for open founder questions — add new ones here first, going forward (see `03_improvements.md` P5).**
...
- ~~Q3. PathWest "Start Before 10am" Guidance~~ **RESOLVED 2026-07-20 — real official source found (see `king-edward-start-time-constraint.md`).** Anthony found and provided the actual PathWest patient instructions PDF containing this guidance — no longer an open question, no longer general internet research.
...
**2026-07-20 (real source found):** Q3 fully resolved — Anthony found and provided the actual official PathWest patient instructions PDF, replacing the "general internet research" framing with a real citation. See `king-edward-start-time-constraint.md` for full detail.

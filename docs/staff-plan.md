...
> **2026-07-28 CORRECTED (same day) — AM/PM shift structure NOT dropped.** An earlier version of this banner (v1.0, same day) incorrectly stated the AM/PM staff split was being dropped — this was a misinterpretation, corrected per Anthony's direct correction: "i have not said anything about dropping the am/pm titles as we are still looking to operate in a shift model." **§2 and §2A below (org chart, AM/PM shift roster) stand as previously documented — no change to shift structure.** The actual instruction: recruit/roster service staff cross-trained across multiple service SPECIALTIES (e.g. hair+nails, massage+beauty) for roster flexibility and relief coverage — see `dual-role-staffing-model-2026-07-28.md` v2.0 for the corrected model. The Manager/Receptionist role's hours (opening until last AM package client leaves, not a fixed PM cutoff/split shift) and beauty-field industry experience requirement — both correct in v1.0 — remain in force, see §3 below. Financial-impact: recomputed under the corrected model — **no material change to the standing +A$25,087.07/month baseline** (see `dual-role-staffing-model-2026-07-28.md` v2.0 §Financial Impact for the computation).
...
**Model:** Wage-based employment (not room rental). Practitioners employed directly by YETI Holding Trust trading as GTT Center Perth.
...
- Hair & Beauty Industry Award MA000005 — massage, nails, brows
...
> **NOTE 2026-07-28:** this org chart still shows a "Service Manager" AM-only branch and a separate "PM Service Therapist" — both stale relative to the actual current PM model even independent of today's correction (see the 2026-07-14 top-of-document banner: PM is actually 4 dedicated casual hires per `pm-staffing-roster.md`, not 1 PM Service Therapist). **The AM/PM shift split itself is NOT being dropped** (corrected 2026-07-28, see `dual-role-staffing-model-2026-07-28.md` v2.0) — an earlier same-day version of this banner incorrectly said otherwise. The genuine, still-open staleness here is only the "Service Manager"/"PM Service Therapist" labelling not matching `pm-staffing-roster.md`'s 4-hire model — not the AM/PM structure itself, which stands.
...
> **CORRECTED 2026-07-28 (same day):** an earlier same-day banner here incorrectly said this table's AM/PM split was being dropped. **That was wrong — the AM/PM shift split below stands as documented.** Anthony's actual instruction (`dual-role-staffing-model-2026-07-28.md` v2.0) is about recruiting staff cross-trained across multiple service specialties (e.g. hair+nails) within this existing shift structure, not merging AM and PM into one flexible pool. Table below is current, not historical.
...
**Status:** Full-time salaried — **ON HOLD 2026-07-29, not an independently actionable item right now.** Anthony's decision: recruitment cannot begin until BOTH a pathology partnership (WDP/PathWest/Clinipath) AND a physical venue location are confirmed. This role remains the first hire and venue cannot safely open without it (first-aid/EpiPen response, fire warden, clinical escalation contact, staff supervision), but it is the **next step once the partnership+location gate clears**, not something to start now — see hiring sequence in Section 7 and `hr-framework.md`.  
...
- Cert III HLT37215 Pathology Collection minimum; Cert IV preferred
- Experience with venepuncture, capillary collection, paediatric/maternity settings
- WDP/PathWest credential check (must be approved collector under their NATA accreditation)
- Working with Vulnerable People check (pregnant women)
- Current CPR (HLTAID011)

**Responsibilities:**
- Perform blood collections T=0, T=60, T=120 for all GTT patients
- Prepare and label specimens to WDP/PathWest chain of custody standards
- Operate and maintain collection room to ACSQHC standards
- Administer 75g glucose drink with instructions
- Document collection times accurately
- Courier/dispatch specimens to pathology lab on schedule
...
**Award:** Hair & Beauty Industry Award MA000005  
**Classification:** Level 5 (Cert IV Massage Therapy + Pregnancy Massage Specialisation)  
**Base rate:** A$26.56/hr (MA000005 L5, 2026 — confirm against current FWC determination)  
...
**Requirements at hire:**
- Cert IV Massage Therapy (HLT52015) minimum
- Pregnancy massage specialisation (at least 20 hours CPD or dedicated course)
- Current professional indemnity + public liability insurance (GTT CP also holds venue liability)
- ATMS or AMT membership preferred
- First aid current (HLTAID011)
- Genuine interest in maternal wellness

**Responsibilities:**
- Deliver 60-min pregnancy massage treatments to GTT patients
...
**Status:** Permanent part-time  
**Award:** Hair & Beauty Industry Award MA000005  
**Classification:** Level 3 (Cert III Nail Technology)  
**Base rate:** A$23.49/hr (MA000005 L3, 2026)  
...
**Requirements at hire:**
- Cert III Nail Technology (SHB30115)
- Experience with pregnancy-safe products (9-free or 12-free polishes)
- Understanding of contraindicated ingredients in pregnancy (no acrylic monomer; gel with UV lamp limited exposure)
- Knowledge of nail station ventilation (local exhaust ventilation required — WorkSafe WA)
- Own professional kit preferred

**Responsibilities:**
- Deliver manicure and pedicure services (45–60 min)
- Maintain nail station cleanliness and ventilation compliance
- Maintain pregnancy-safe product inventory (order when low)
- Sterilise/sanitise tools to AS 4187 standards
- Upsell retail nail care products where appropriate

---

### Beauty Therapist / Brows
**Status:** Permanent part-time (initially casual 3 days/week until demand confirmed)  
**Award:** Hair & Beauty Industry Award MA000005  
**Classification:** Level 3 (Cert III Beauty Therapy)  
**Base rate:** A$23.49/hr | Casual loading if casual: A$29.36/hr  
...
**Requirements at hire:**
- Cert III Beauty Therapy (SHB30115)
- Brow shaping and lamination experience
- PPD-free tint products only (pregnancy requirement — patch test knowledge)
- Waxing proficiency

**Responsibilities:**
- Brow shaping, waxing, tinting (PPD-free)
- Facial treatments (pregnancy-safe only — no retinoids, AHAs >5%, laser, galvanic)
- Spray tan if booth installed (DHA-free alternatives or opt-out guidance for pregnancy)
- Maintain beauty station to hygiene standards
...
**Responsibilities:**
- Open venue (7:15am): unlock, coffee/tea prep, lounge setup, check Fresha for day's bookings
- Greet every patient by name on arrival
- Confirm fasting status, collect referral form and Medicare card
- Introduce patient to phlebotomist for T=0 collection immediately on arrival
- Manage Fresha calendar: same-day changes, waitlist notifications
- Answer phone and email enquiries
- Escort patients to treatment rooms for each service
...
> **Sequencing note (updated 2026-07-29 — founder instruction):** GTT Center Perth is NOT recruiting or looking for any staff — including the Venue Manager — until BOTH a pathology partnership (WDP/PathWest/Clinipath) AND a physical venue location are confirmed (two-gate condition, widened 2026-07-29 from the original location-only gate). The "Week 1" labels below describe the relative sequence of hires once recruitment begins, not literal calendar weeks starting now. **The Venue Manager remains the first hire once recruitment starts, but this is a downstream next-step, not an independently actionable item right now** — nothing to do on this hire until the partnership+location gate clears.

| Role | Hire by (relative to recruitment start, not now) | Notes |
|---|---|---|
| **Venue Manager (Managing Director)** | **Recruitment Week 1 — ON HOLD, does not begin until BOTH a partnership and a location are confirmed** | **First hire once recruitment starts. Venue cannot safely open without this role in place — first-aid/EpiPen holder, fire warden, clinical escalation contact, and day-to-day staff supervisor all depend on it. Job posting document ready: `docs/venue-manager-job-posting.md` — built in advance, parked, not a current action item.** |
...
- [ ] Payroll tax registration if total wages exceed WA threshold (~A$1M/year — not triggered at launch but confirm)
- [ ] Fair Work obligations: employment contracts, pay slips, record-keeping
- [ ] Fair Work Information Statement issued to each new employee
- [ ] Superannuation: choose fund or default fund, set up super payments (monthly by 28th)
...
- [Fair Work — Clerks Award MA000002](https://www.fairwork.gov.au/employment-conditions/awards/awards-summary/ma000002-summary)
...
**2026-07-28 (AM/PM staff split dropped) — SUPERSEDED SAME DAY, SEE BELOW.** Anthony's direct instruction: drop the AM/PM staff split entirely, all service staff dual/multi-role capable (AM or PM shift-flexible), one combined recruitment ad not separate AM/PM ads. Manager/Receptionist hours changed to "opening until last AM client leaves" (was fixed split-shift with a 12:00-15:00 break) and a beauty-field industry experience requirement added. Added superseded banners to §2 (org chart), §2A (AM/PM shift roster table), and updated §3's Receptionist role detail directly. New canonical staffing-model document: `dual-role-staffing-model-2026-07-28.md`. **Financial impact NOT assumed unchanged** — flagged as requiring recomputation once a real dual-role headcount is validated; treat the standing +A$25,087.07/month baseline as provisional pending that work, not restated as current fact.

**2026-07-28 (correction, same day) — AM/PM shift split is NOT dropped.** The entry immediately above was a misinterpretation of Anthony's actual instruction, corrected same day: "i have not said anything about dropping the am/pm titles as we are still looking to operate in a shift model." The real instruction is cross-training staff across multiple SERVICE SPECIALTIES (e.g. hair+nails, massage+beauty) for roster flexibility, not merging AM/PM shifts. Reverted the §2/§2A superseded banners — the org chart's AM/PM structure and the shift roster table both stand as previously documented (only the pre-existing "Service Manager"/"PM Service Therapist" label staleness noted in §2's banner remains, unrelated to this correction). Manager/Receptionist hours and beauty-field requirement changes are unaffected and remain in force. Recomputed financial impact under the corrected model: **no material change to the +A$25,087.07/month baseline** — see `dual-role-staffing-model-2026-07-28.md` v2.0 §Financial Impact.

**2026-07-29 (Venue Manager hire put ON HOLD, two-gate condition)** — Anthony's decision: recruitment (including the Venue Manager, the first hire) cannot begin until BOTH a pathology partnership (WDP/PathWest/Clinipath) AND a physical venue location are confirmed — widened from the original location-only gate. Removed "critical-path, start now" framing from §3 (role detail) and §7 (hiring timeline) — reframed as "next step once the partnership+location gate clears," not an independently actionable item right now. `docs/venue-manager-job-posting.md` similarly updated to ON HOLD status. Real critical path right now is the partnership+location confirmation itself (property search + WDP conversation), not this hire.

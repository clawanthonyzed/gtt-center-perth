# PathWest + Clinipath Outreach — 2026-07-27

**Prepared by:** Reed (Partnerships Coordinator), at Anthony's direct instruction
**Purpose:** Complete the pathology-partner outreach (WDP already contacted via online enquiry form — see `reed-partnerships.md`/`cutoff-time-CORRECTION.md`). PathWest and Clinipath had not been contacted as of 2026-07-21; this session drafts and readies outreach to both, using the same corrected message content as `lab-partnership-email-draft.md`'s Template A, sent by email since both organisations have published business-development email addresses (unlike WDP, which was approached via its dedicated online form).

> **FLAGGED — CAPABILITY GAP, NOT ASSUMED DONE:** This agent checked for an email-sending capability in this environment (mail/mailx/sendmail binaries, SMTP config, Resend/SendGrid integration for this venture) and found none configured. **These emails are drafted and ready to send — they have not been confirmed as sent.** Anthony or Reed (a real person acting on Reed's brief) needs to actually send these, then update the Outreach Status tracker in `reed-partnerships.md` with the real send date/confirmation.
...
**Note:** identical content to the WDP enquiry (per `lab-partnership-email-draft.md`), sent to PathWest's general enquiry address since no dedicated LCC/partnerships program page was found for PathWest (government-operated, less commercial flexibility per `reed-partnerships.md` §1) — general BD enquiry is the correct channel here.
...
**Note:** Clinipath has no documented Licensed Collection Centre-equivalent program (per `reed-partnerships.md` §1) — this is a general business-development inquiry, consistent with the venture's own "approach order: WDP (documented LCC program) → PathWest (government, backup) → Clinipath (contingency, general BD inquiry only)." Anthony's instruction was to contact all three now rather than wait for WDP/PathWest to decline first — this supersedes the earlier sequencing note in `pathology-partnership-brief.md`/`reed-partnerships.md` that said "approach Clinipath only if both WDP and PathWest decline."
...
## 4. PathWest Replied (2026-08-27)

**Classification per the response-handling playbook (`docs/reed-partnerships.md` §1a): genuine engagement, requests further information. NOT a yes, NOT a no, NOT a decline.** PathWest has not agreed to anything; they are willing to evaluate the concept once given more detail. This does not change WDP's status as the primary prospective pathology partner.

### 4a. The Reply Received (transcribed in full, nothing added or omitted)

**From:** "Pathwest, Client Liaison" &lt;Pathwest.ClientLiaison@health.wa.gov.au&gt;, replied by Meera Bennett, Medical Liaison Officer, PathWest Laboratory Medicine (Meera.Bennett@health.wa.gov.au, 0448 148 818)
**CC:** Sura Al Saedi (PathWest)
**Date:** Thursday, 27 August 2026
**Subject:** RE: Following up: Onsite Blood Collection Partnership Enquiry

> Hi Anthony
>
> Thank you for following up, and apologies that you haven't received a response to your initial enquiry.
>
> We would be happy to learn a little more about your proposed concept to determine whether this is something PathWest may be able to consider.
>
> Could you please provide some further information regarding the proposed venue and partnership, including:
> - The proposed location of the venue
> - An overview of the wellness services being offered
> - How you envisage the onsite pathology collection service operating
> - The expected volume and frequency of patients requiring collection
> - Your anticipated timeframe for opening/commencing the service
> - Any other relevant details regarding the proposed arrangement
>
> Once I have some further information, we can review the proposal and determine the appropriate next steps.
>
> Kind regards,
> Meera Bennett

### 4b. What This Unlocks / What Remains Open

**Unlocked:** a real, named PathWest contact (Meera Bennett) who has confirmed PathWest is willing to actually evaluate the concept, not just acknowledge receipt. This is a genuine second live channel alongside WDP, not merely a backup on paper.

**Remains open, unaffected by this reply:** WDP's own commercial/rental figure and employment-model position (`docs/VERIFICATION-TRACKER.md` items 1c/1d), the physical venue itself, the entity-structure decision. This reply is an information request, not a commercial negotiation, it does not require founder-level input beyond approving the drafted reply below.
...
**CLASSIFICATION CORRECTED, 2026-08-28 (same day, later): the original classification below was premature and is withdrawn, not just appended to.** On review, Meera's reply is genuinely ambiguous and does not, on its own, establish a decline of PathWest as a viable partner for GTT's actual proposed model. **Status: OPEN, pending a direct clarifying question not yet asked.** See §4d-ii (corrected) and §4d-iv (new clarifying draft, replacing the previously-drafted closing acknowledgment, which has NOT been and must NOT be sent) below. WDP remains primary and unaffected; WDP has not yet replied.
...
### 4d-ii. What Was Declined vs. What Remains Open (CORRECTED, 2026-08-28)

**Genuinely ambiguous, not a clear decline of the actual proposed model.** Meera's own words: "we currently do not have the capacity to provide collection staff to non-PathWest collection sites." This was read, prematurely, as a direct no to GTT's ask. On review, this reading assumed "collection staff" meant phlebotomists performing the venepuncture itself, and assumed Meera correctly understood that GTT's own model is to employ its own phlebotomists and run its own collection room(s), with a pathology partner providing lab testing and results reporting only, not collection staff at all. **Neither assumption was confirmed before drafting a closing reply. Two real open questions:**

1. Does "collection staff" in her reply mean phlebotomists (the people drawing blood) specifically, or does it mean sample-transport/courier staff, or both? Not established either way.
2. Did Meera's reply address the model GTT actually proposed (GTT self-collects, PathWest limited to lab testing/reporting), or did she assume PathWest would need to supply/operate the collection itself (a materially different, larger ask)? Her "clinic with doctors" comment reads as though she assumed the latter, but this has not been confirmed, and may simply be a misunderstanding of what was actually being proposed, not evidence PathWest can't help at all.

**"Clinic with doctors," genuinely not understood yet, not just noted and dropped:** what having a GP on-site would actually involve, and what the GP's role/purpose would be in this arrangement, is not established. Whether a GP is required specifically to unlock the self-collection/lab-processing-only model in question 2 above, or is a separate/different model to what she was describing, is unknown and needs to be asked directly, not assumed.

**Status: OPEN pending clarification, not effectively declined.** See §4d-iv below for the clarifying question now drafted in place of the previously-drafted closing acknowledgment (which was never sent and must not be).
...
### 4d-iv. Clarifying Reply to Meera Bennett (SENT 2026-08-28, by Anthony directly, outside this repository's workflow)

**Status: SENT.** No agent sent this email; Anthony sent it himself and this record was updated afterward to match. **No response from Meera Bennett or PathWest has been received yet: none invented or assumed.**

**Note on what was actually sent vs. the drafted version:** near-identical to the last draft, one difference: Anthony dropped the venture name "GTT Center Perth" entirely (the draft said "we're looking at GTT Center Perth employing..."; the sent version says "we're looking at employing..."), consistent with the standing instruction to keep this correspondence provider-neutral/unnamed. Otherwise the body text is unchanged.
...
**Design notes (not for inclusion in the sent email):** all 5 corrections from the prior round were applied and sent as drafted (no "mismatch" framing, 2-options reframe with the fallback stated, no assumption on transport/testing capability, no GP question, no "we deliver samples ourselves" bullet); the only further change was Anthony's own edit dropping the venture name. **Sent 2026-08-28** (see status line above).

### 4d-v. Queued Follow-Up Question (NOT YET SENT, ask only after Meera's reply to the 2026-08-28 email above)
...
### 4e-v. Reply to Meera Bennett (SENT 2026-08-29, by Anthony directly, outside this repository's workflow)

**Status: SENT.** No agent sent this email; Anthony sent it himself and this record was updated afterward to match, same discipline as `docs/wdp-followup-draft-2026-08-20.md`. **No response from Meera Bennett or PathWest has been received yet: none invented or assumed.**

**Note on what was actually sent vs. the drafted version (§4e-iv):** Anthony sent a version that differs from the draft in three respects, all his own edits:
1. **Pickup timing wording changed.** The draft said "one collection at the end of each morning"; the sent version says "one collection in the afternoon, once all clients have completed their final draw for the day." This is a wording clarification, not an operating-model change: it is consistent with the established 18-clients/morning-session model (`docs/CURRENT-STATE.md` §1, `docs/architecture/VENUE-PROGRAM-AUTHORITATIVE.md`) and with the venue's own afternoon-wellness-destination operating hours already established in §4c of this same file ("in the afternoons, once the morning session ends, the same venue operates as a standalone wellness destination"). Morning session for clients, single afternoon pickup — no contradiction.
2. **The two open questions were merged.** The draft had the tubes/consumables/glucose-drink question and the lab-drop-off-fallback question as two separate bullet points; the sent version merges them into one paragraph. Same substance, nothing dropped.
3. **Critical-path sentence extended.** The draft said "this is genuinely the piece we need resolved before we finalise a location, rather than the other way around." The sent version reads "a partnership or lab testing agreement is genuinely the piece we need resolved before we finalise a location, rather than the other way around, as the whole business revolves around offering the gestational glucose tolerance test" — Anthony's own addition, not present in the draft, making the "whole business revolves around the GTT" framing explicit.
...
> Thanks so much for the detail, that's really helpful.
>
> On the courier timing concern: we wouldn't need interval-based pickups throughout the day. Our model is for one collection in the afternoon, once all clients have completed their final draw for the day, so a single end-of-day pickup rather than pickups matched to the individual test intervals. Hopefully that fits a normal route much more easily than what you may have pictured.
>
> We'd collect using grey top (Fluoride Oxalate) tubes as you've indicated, and would store and handle samples in line with standard practice for that tube type until the end-of-day pickup.
>
> On location, we don't have a venue/location secured yet, but the rough area we're looking at is Perth metro, roughly Osborne Park through to Cockburn and out to Maddington. A partnership or lab testing agreement is genuinely the piece we need resolved before we finalise a location, rather than the other way around, as the whole business revolves around offering the gestational glucose tolerance test.
>
> On volume, our current planning model is up to 18 clients per morning session, Monday to Saturday, though that's a planning target and the actual number some days may be lower.
>
> A couple of open questions I have if a partnership could be created:
> Would this kind of arrangement be able to include supplying the tubes and other consumables needed for the test, including the glucose drink? If it turns out couriers genuinely can't accommodate pick-ups even with the above, would it be possible for our own staff to drop samples off at a PathWest lab directly instead?
>
> Thanks again, really appreciate you helping us work through this.
>
> Regards, Anthony

**Design notes (not for inclusion in the sent email):** all three differences from §4e-iv are recorded factually above, as Anthony's own edits, not inferred reasons. No new fact was introduced beyond what was already drafted: tube type, rough target area, 18-clients/morning-session volume figure with its usual "may be lower" caveat, tubes/consumables/glucose-drink supply question, and lab-drop-off fallback are all unchanged in substance from §4e-iv. The GP/doctor siting-preference question (§4d-v) was not asked this round, consistent with it being held for a later round. **Sent 2026-08-29** (see status line above). **Status: OPEN, awaiting reply — no response from Meera Bennett has been received yet, none invented or assumed.**

### 4e-vi. Reply Received (2026-09-01), Unconditional Courier Confirmation

**Classification: genuine, unconditional confirmation, PathWest's most advanced position yet.** Unlike her §4e-i/§4e-ii replies, which were conditional on knowing a rough location and volume first, this reply commits to courier pickup for grey-top (Fluoride Oxalate) tubes without restating that condition. The most reasonable reading is that the location/volume detail Anthony gave in the §4e-v email (Perth metro, Osborne Park through Cockburn to Maddington, up to 18 clients/morning session Monday–Saturday) was sufficient for her to commit.

**From:** "Pathwest, Client Liaison" &lt;Pathwest.ClientLiaison@health.wa.gov.au&gt;, replied by Meera Bennett, Medical Liaison Officer, PathWest Laboratory Medicine
**Date:** Tuesday, 1 September 2026 01:25:03 UTC (Tuesday, 1 September 2026, AWST morning)
**Subject:** RE: Following up: Onsite Blood Collection Partnership Enquiry

> Hi Anthony
>
> We can definitely accommodate courier pick ups for Fluoro ox tubes, and if you are planning to send those many samples we can supply the tubes, biohazard bags etc at no cost.
> We do not supply the glucose drink though.
>
> Kind Regards,
>
> Meera Bennett | Medical Liaison Officer | PathWest Laboratory Medicine

**What this resolves:** one of the two open questions carried since §4e-v/§4d-iv — "would this kind of arrangement be able to include supplying the tubes and other consumables needed for the test, including the glucose drink" — is now answered, partially. Tubes and biohazard bags: supplied by PathWest at no cost. Glucose drink: **not** supplied by PathWest; this is a new, small open logistics item for GTT to source itself, not a blocker.

**What this does not address:**
- The second open question carried since §4e-v/§4d-iv (own-staff drop-off fallback if couriers can't accommodate pickups) is not addressed. This is now moot rather than unanswered — courier collection has just been confirmed unconditionally, so the fallback scenario it was meant to cover no longer applies.
- The still-queued GP/clinic-with-doctors siting-preference question from §4d-v is not addressed and remains queued, unasked, unaffected by this reply.

**Where this leaves PathWest relative to the other three candidates:** this is the first unconditional courier-collection confirmation received from any of the four pathology candidates (WDP, PathWest, Clinipath, ACL) approached to date. This is stated as a plain fact, not a recommendation — WDP remains marked primary per repository convention (`docs/reed-partnerships.md`) until Anthony decides otherwise; whether to change primary/secondary status is Anthony's decision alone, not made here.

**Status: reply sent — see §4e-vii below.**

### 4e-vii. Reply to Meera Bennett (SENT 2026-09-03, by Anthony directly, outside this repository's workflow)
...
> Hi Meera,
>
> Thanks so much, that's great news — and really helpful that you can supply the tubes and biohazard bags at no cost, that takes care of a big piece of the puzzle.
>
> A few things I'd love to understand better as we think this through:
>
> Would you be able to give me a rough ballpark on cost, both for the courier pickup side and for the lab testing itself? I understand the courier cost will likely depend on our exact location once we have one, but even a rough range would help us plan.
>
> Also, how does an arrangement like this typically work in practice, is it a formal contract, more of a partnership, or a fee-for-service type setup? Understanding the shape of it would really help us plan properly.
>
> What would be the next steps from here, from your side?
>
> Thanks again for all your help working through this with us.
>
> Regards,
> Anthony

**Design notes (not for inclusion in the sent email):**
1. **Deliberately does not ask about glucose-drink sourcing.** PathWest's §4e-vi reply confirmed they do not supply it. Rather than ask Meera about sourcing, GTT has separately identified a candidate supplier privately: **Diabetes WA — 75g/300ml glucose drink, A$2.80/unit, WA-based, online order cap of 15 units per order with bulk quantities available via direct contact.** This is a private, internal planning note only, not communicated to Meera or referenced anywhere in the sent email — it does not appear in this outreach thread's correspondence with PathWest.
2. **Deliberately does not ask about the own-staff drop-off fallback.** That question is now moot per §4e-vi's finding (courier collection has been unconditionally confirmed, so the fallback scenario it was meant to cover no longer applies) — not re-asked here.
3. **Deliberately does not ask the "clinic with doctors" siting-preference-vs-universal-rule question.** Still queued, unasked, at §4d-v — held back per standing instruction, not raised this round.
4. **Three new questions asked, all genuinely open, none assumed:** (a) a rough ballpark cost for both courier pickup and lab testing, explicitly acknowledging the courier figure will likely depend on the eventual site location; (b) what shape the arrangement would take in practice — formal contract, partnership, or fee-for-service — since none of PathWest's replies to date have described the commercial structure; (c) what PathWest's own next steps would be from here.
5. **Standing decision, recorded here for status accuracy: Anthony has decided not to lock anything in with PathWest/Meera until WDP (Carole Rivers, primary candidate) has replied to an upcoming follow-up, planned for Monday 2026-09-07 and not yet sent as of this logging.** This email to Meera is exploratory/information-gathering only — it does not constitute or signal a commitment to PathWest, and is framed in the status update below accordingly. WDP remains primary per repository convention (`docs/reed-partnerships.md`), unaffected by this email.

## What Happens Next

**PathWest:** §4e-vii SENT 2026-09-03 — asked for a rough cost ballpark (courier pickup + lab testing, acknowledging courier cost is likely location-dependent), the shape of a potential arrangement (formal contract / partnership / fee-for-service), and PathWest's own next steps. Deliberately did not ask about glucose-drink sourcing (GTT has privately identified Diabetes WA — 75g/300ml, A$2.80/unit, WA-based, 15-unit online order cap with bulk available via direct contact — as a candidate supplier; this is an internal planning note only, not communicated to Meera). Own-staff drop-off fallback question remains moot (per §4e-vi). GP/siting-preference question (§4d-v) remains queued, unaffected. **Status: OPEN — exploratory/information-gathering only, not a commitment. Anthony has decided not to lock anything in with PathWest until WDP (Carole Rivers) has replied to an upcoming follow-up planned for Monday 2026-09-07 (not yet sent as of this logging).** Awaiting both Meera's answers to §4e-vii and the outcome of that 2026-09-07 WDP follow-up before any decision on which partner to progress with. **Clinipath:** still awaiting any reply to the 2026-08-27 follow-up; the same self-collection/lab-processing-only clarifying framing should be part of the standard question set once Clinipath replies (GP question held back there too, for consistency, until there's a reason to ask it), not treated as a PathWest-specific fix, see `docs/architecture/WDP-PARTNERSHIP-ACTIVATION-PLAN.md` §2 (new Model D) and `docs/reed-partnerships.md`. **WDP:** remains primary per repository convention, unaffected by this development; a follow-up to Carole Rivers is planned for Monday 2026-09-07, not yet sent as of this logging — the same clarifying question applies once WDP responds. When Clinipath or WDP reply further, log it here, in `docs/VERIFICATION-TRACKER.md` (item 4 or item 1c), and in `docs/reed-partnerships.md`'s tracker, and update this file's status accordingly. Do not invent or assume a response.
...
**2026-09-01 (§4e-vi, PathWest gives unconditional courier confirmation):** Meera Bennett replied confirming PathWest "can definitely accommodate courier pick ups for Fluoro ox tubes," and will supply tubes/biohazard bags at no cost (glucose drink excluded — new small open logistics item). Unlike §4e-i/ii, this reply is not conditional on first knowing location/volume — reasonable reading is that the detail given in §4e-v was sufficient for her to commit. Resolves the tubes/consumables half of the open question carried since §4e-v/§4d-iv; glucose-drink supply answered no. The own-staff drop-off fallback question is now moot (courier confirmed), not answered. GP/siting-preference question (§4d-v) remains queued, unaffected. Noted as fact, not recommendation: this is the first unconditional courier-collection confirmation among the four candidates (WDP, PathWest, Clinipath, ACL); WDP remains primary per repository convention until Anthony decides otherwise, that decision is his alone. No reply drafted yet. "What Happens Next" section updated to match.

**2026-09-01 (§4e-vi, PathWest gives unconditional courier confirmation):** Meera Bennett replied confirming PathWest "can definitely accommodate courier pick ups for Fluoro ox tubes," and will supply tubes/biohazard bags at no cost (glucose drink excluded — new small open logistics item). Unlike §4e-i/ii, this reply is not conditional on first knowing location/volume — reasonable reading is that the detail given in §4e-v was sufficient for her to commit. Resolves the tubes/consumables half of the open question carried since §4e-v/§4d-iv; glucose-drink supply answered no. The own-staff drop-off fallback question is now moot (courier confirmed), not answered. GP/siting-preference question (§4d-v) remains queued, unaffected. Noted as fact, not recommendation: this is the first unconditional courier-collection confirmation among the four candidates (WDP, PathWest, Clinipath, ACL); WDP remains primary per repository convention until Anthony decides otherwise, that decision is his alone. No reply drafted yet. "What Happens Next" section updated to match.

**2026-08-29 (§4e-iv reply SENT, recorded after the fact):** Anthony sent the reply to Meera Bennett directly, outside this repository's workflow. The actual sent text differs from the drafted version (§4e-iv) in three respects, all his own edits, not oversights: (1) pickup-timing wording changed from "one collection at the end of each morning" to "one collection in the afternoon, once all clients have completed their final draw for the day" — a wording clarification, not an operating-model change, consistent with the established 18-clients/morning-session model (`docs/CURRENT-STATE.md` §1, `docs/architecture/VENUE-PROGRAM-AUTHORITATIVE.md`) and with §4c's own afternoon-wellness-destination framing; (2) the two open questions (consumables/glucose-drink supply, lab-drop-off fallback) merged from two bullet points into one paragraph, same substance, nothing dropped; (3) the critical-path sentence extended with "as the whole business revolves around offering the gestational glucose tolerance test," Anthony's own addition, not present in the draft. Added as new §4e-v. Status changed to SENT; overall PathWest status remains OPEN, awaiting reply. No response from Meera Bennett or PathWest received yet, none invented or assumed. "What Happens Next" section updated to match.
